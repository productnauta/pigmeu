"use strict"; 
const { registerBlockType: customRegisterBlockType20x } = wp.blocks;
const mygcelx15 = wp.element.createElement;

customRegisterBlockType20x( 'aiomatic-automatic-ai-content-writer/aiomatic-ideogram-image-generator', {
