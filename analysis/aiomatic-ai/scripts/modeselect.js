...
function hideImageArticle(number)
{
    if(jQuery('#enable_ai_images_article' + number).val() == '1' || jQuery('#enable_ai_images_article' + number).val() == '2' || jQuery('#enable_ai_images_article' + number).val() == '4' || jQuery('#enable_ai_images_article' + number).val() == '5')
    {
        jQuery('.hideImgArticle' + number).show();
    }
    else
    {
        jQuery('.hideImgArticle' + number).hide();
    }
    if(jQuery('#enable_ai_images_article' + number).val() == '1')
    {
        jQuery('.hideDalleArticle' + number).show();
    }
    else
    {
        jQuery('.hideDalleArticle' + number).hide();
    }
}
...
function createModeSelect(i) {
    ...
    if(jQuery('#enable_ai_images_article' + i).val() == '1' || jQuery('#enable_ai_images_article' + i).val() == '2' || jQuery('#enable_ai_images_article' + i).val() == '4' || jQuery('#enable_ai_images_article' + i).val() == '5')
    {
        jQuery('.hideImgArticle' + i).show();
    }
    else
    {
        jQuery('.hideImgArticle' + i).hide();
    }
    if(jQuery('#enable_ai_images_article' + i).val() == '1')
    {
        jQuery('.hideDalleArticle' + i).show();
    }
    else
    {
        jQuery('.hideDalleArticle' + i).hide();
    }
