...
jQuery(document).ready(function ($)
{
    ...
    function aiomaticSetContentPost(editorId, content)
    {
        var editor = tinyMCE.get(editorId);
        if (editor) 
        {
        ...
        $.ajax({
            ...
            success: function (res){
                if(res.success == true)
                {
                    ...
                    if(aiomatic_step === 'description')
                    {
                        aiomaticSetContentPost('content', res.data.content);
                    }
                    if(aiomatic_step === 'short')
                    {
                        aiomaticSetContentPost('excerpt', res.data.content);
                    }
                    if(aiomatic_step === 'tags')
                    {
