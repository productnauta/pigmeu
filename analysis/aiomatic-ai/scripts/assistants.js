...
jQuery(document).ready(function()
{
    ...
    jQuery('input.god_mode-edit-checkbox').on('change', function(e) {
        ...
        if(jQuery('#function_chart-edit').is(":checked"))
        {
            chart = '1';
        }
        ...
        if(jQuery('#function_ideogram-edit').is(":checked"))
        {
            ideogram = '1';
        }
        ...
        if(jQuery('#function_toubiz-edit').is(":checked"))
        {
            toubiz = '1';
        }
        ...
        if(jQuery('#function_end-edit').is(":checked"))
        {
            end = '1';
        }
        ...
        if(jQuery('#function_threads-edit').is(":checked"))
        {
            threads = '1';
        }
        ...
        if(jQuery('#function_ai-edit').is(":checked"))
        {
            ai = '1';
        }
        ...
        if(jQuery('#function_google_image-edit').is(":checked"))
        {
            google_image = '1';
        }
        if(jQuery('#function_database-edit').is(":checked"))
        {
            database = '1';
        }
        if(jQuery('#function_omniblock-edit').is(":checked"))
        {
            omniblock = '1';
        }
        ...
        jQuery.ajax({
            ...
            data: {action: 'aiomatic_get_god_mode_function', god_mode: god_mode, omniblock: omniblock, chart: chart, end: end, lead_capture: lead_capture, ai: ai, stable_video: stable_video, google_image: google_image, database: database, webhook: webhook, linkedin: linkedin, reddit: reddit, youtube_community: youtube_community, business: business, pinterest: pinterest, instagram: instagram, twitter: twitter, threads: threads, facebook_image: facebook_image, facebook: facebook, dalle: dalle, stable: stable, midjourney: midjourney, replicate: replicate, ideogram: ideogram, amazon: amazon, amazon_details: amazon_details, scraper: scraper, rss: rss, google: google, captions: captions, royalty: royalty, youtube: youtube, email: email, toubiz: toubiz, nonce: aiomatic_object.nonce},
            type: 'POST',
    ...
    jQuery('input.god_mode-checkbox').on('change', function(e) {
        ...
        if(jQuery('#function_chart').is(":checked"))
        {
            chart = '1';
        }
        ...
        if(jQuery('#function_ideogram').is(":checked"))
        {
            ideogram = '1';
        }
        ...
        if(jQuery('#function_toubiz').is(":checked"))
        {
            toubiz = '1';
        }
        ...
        if(jQuery('#function_omniblock').is(":checked"))
        {
            omniblock = '1';
        }
        ...
        if(jQuery('#function_end').is(":checked"))
        {
            end = '1';
        }
        ...
        if(jQuery('#function_threads').is(":checked"))
        {
            threads = '1';
        }
        ...
        if(jQuery('#function_ai').is(":checked"))
        {
            ai = '1';
        }
        ...
        if(jQuery('#function_google_image').is(":checked"))
        {
            google_image = '1';
        }
        if(jQuery('#function_database').is(":checked"))
        {
            database = '1';
        }
                ...
                success: function (res){
                    if(res.status === 'success'){
                        if(res.data !== undefined)
                        {
                            ...
                            if(functions_str.includes('aiomatic_chart'))
                            {
                                jQuery("#function_chart-edit").prop( "checked", true );
                            }
                            if(functions_str.includes('aiomatic_end'))
                            {
                                jQuery("#function_end-edit").prop( "checked", true );
                            }
                            ...
                            if(functions_str.includes('aiomatic_ideogram_image'))
                            {
                                jQuery("#function_ideogram-edit").prop( "checked", true );
                            }
                            if(functions_str.includes('aiomatic_stable_video'))
                            {
                                jQuery("#function_stable_video-edit").prop( "checked", true );
                            }
                            if(functions_str.includes('aiomatic_google_image'))
                            {
                                jQuery("#function_google_image-edit").prop( "checked", true );
                            }
                            if(functions_str.includes('aiomatic_database'))
                            {
                                jQuery("#function_database-edit").prop( "checked", true );
                            }
                            if(functions_str.includes('aiomatic_omniblock'))
                            {
                                jQuery("#function_omniblock-edit").prop( "checked", true );
                            }
                            ...
                            if(functions_str.includes('aiomatic_toubiz'))
                            {
                                jQuery("#function_toubiz-edit").prop( "checked", true );
                            }
                            if(functions_str.includes('aiomatic_generate_reasoning'))
                            {
                                jQuery("#function_ai-edit").prop( "checked", true );
                            }
                            ...
                            if(functions_str.includes('aiomatic_publish_threads'))
                            {
                                jQuery("#function_threads-edit").prop( "checked", true );
                            }
    ...
    jQuery(".aiomatic_convert_assistant").on('click', function(e) {
        e.preventDefault();
        if(confirm('Are you sure you want to convert this to persona?'))
        {
            var assistantid = jQuery(this).attr("conv-id");
            if(assistantid == '')
            {
                alert('Incorrect convert id submitted');
            }
            else
            {
                e.preventDefault();
                var data = {
                    action: 'aiomatic_convert_assistant',
                    assistantid: assistantid,
                    nonce: aiomatic_object.nonce,
                };
                jQuery.ajax({
                    ...
                    type: 'POST',
                    beforeSend: function (){
                        aiomaticLoading2(jQuery('#aiomatic_convert_assistant_' + assistantid));
                    },
                    success: function (res){
                        if(res.status === 'success'){
                            aiomaticRmLoading(jQuery('#aiomatic_convert_assistant_' + assistantid));
                            alert('AI Assistant successfully converted to persona. Check the "Bot Persona Manager" tab in the "AI Chatbot" menu for details.')
                        }
                        else{
                            alert(res.msg);
                            location.reload();
                    ...
                    error: function (r, s, error){
                        alert('Error in processing assistant conversion: ' + error);
                        location.reload();
                    }
                });
            }
