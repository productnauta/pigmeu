...
jQuery(document).ready(function(){
    (function($) {
        ...
        if(window.location.search !== undefined && window.location.search.includes('page=aiomatic_realtime_chatbot_panel'))
        {
            if(activeTab == 'tab-t' || activeTab == 'tab-0')
            {
                jQuery('#btnSubmit').hide();
            }
            else
        ...
        {
            if(activeTab == 'tab-16' || activeTab == 'tab-7')
            {
                jQuery('#btnSubmit').hide();
            }
            else
