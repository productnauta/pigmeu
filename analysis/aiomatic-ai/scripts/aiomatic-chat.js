...
customRegisterBlockType1( 'aiomatic-automatic-ai-content-writer/aiomatic-chat', {
    ...
    edit: (function( props ) {
        ...
        var submit_image = props.attributes.submit_image;
        var submit_full = props.attributes.submit_full;
        ...
        var conversation_starters = props.attributes.conversation_starters;
        var store_data = props.attributes.store_data;
        var additional_bots = props.attributes.additional_bots;
        var bot_workflow = props.attributes.bot_workflow;
        ...
        function updateMessage18x( event ) {
            props.setAttributes( { submit_image: event.target.value} );
		}
        function updateMessage18y( event ) {
            props.setAttributes( { submit_full: event.target.value} );
		}
        ...
        function updateMessage70( event ) {
            props.setAttributes( { conversation_starters: event.target.value} );
		}
        function updateMessage71( event ) {
            props.setAttributes( { store_data: event.target.value} );
		}
        function updateMessage72( event ) {
            props.setAttributes( { additional_bots: event.target.value} );
		}
        function updateMessage73( event ) {
            props.setAttributes( { bot_workflow: event.target.value} );
		}
		return mygcel13(
			'div', 
            ...
            mygcel13(
                ...
                mygcel13(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Select if you want to show to users of the chatbot an initial list of conversations starters, which appear as clickable buttons, for easier starting of conversations. Delimit multiple starters using | characters.'
                )
            ),
			mygcel13(
				'input',
				{ type:'text',placeholder:'Tell me a joke!|What can you do?|How\'s the weather today?|Help me with something.', value: conversation_starters, onChange: updateMessage70, className: 'coderevolution_gutenberg_input' }
			),
            mygcel13(
				'br'
			),
            mygcel13(
				'label',
				{ className: 'coderevolution_gutenberg_label' },
                'Store AI Prompts On OpenAI\'s Part: '
			),
            mygcel13(
                'div', 
                {className:'bws_help_box bws_help_box_right dashicons dashicons-editor-help'}
                ...
                mygcel13(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'If you check this checkbox, the plugin will store all prompts used in the plugin, to allow model dillution and other features on OpenAI API\'s part.'
                )
            ),
            mygcel13(
                'select',
                { value: store_data, onChange: updateMessage71, className: 'coderevolution_gutenberg_select' }, 
                mygcel13(
                    'option',
                    { value: 'off'},
                    'off'
            ...
            mygcel13(
				'label',
				{ className: 'coderevolution_gutenberg_label' },
                'Add Additional Bots To The Conversation: '
			),
            mygcel13(
                'div', 
                {className:'bws_help_box bws_help_box_right dashicons dashicons-editor-help'}
                ...
                mygcel13(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Select additional bots you want to add to the chatbot. You can input a comma separated list of IDs of Bot Personas or AI Assistants.'
                )
            ),
			mygcel13(
				'input',
				{ type:'text',placeholder:'Comma separated list of bot personas/ai assistants', value: additional_bots, onChange: updateMessage72, className: 'coderevolution_gutenberg_input' }
			),
            mygcel13(
				'br'
			),
            mygcel13(
				'label',
				{ className: 'coderevolution_gutenberg_label' },
                'Bot Workflow Configuration String: '
			),
            mygcel13(
                'div', 
                {className:'bws_help_box bws_help_box_right dashicons dashicons-editor-help'}
                ...
                mygcel13(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Set the configurations json string for the bot workflow. Use the workflow builder tool to configure this settings field\'s value.'
                )
            ),
			mygcel13(
				'input',
				{ type:'text',placeholder:'Bot workflows json', value: bot_workflow, onChange: updateMessage73, className: 'coderevolution_gutenberg_input' }
			),
            mygcel13(
				'br'
			),
            ...
            mygcel13(
				'label',
				{ className: 'coderevolution_gutenberg_label' },
                'Form Input Submit Button Image URL: '
			),
            mygcel13(
                'div', 
                {className:'bws_help_box bws_help_box_right dashicons dashicons-editor-help'}
                ...
                mygcel13(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Set the image which will be used as the submit button. To disable this feature, leave this field blank. It will overwrite the text of the submit button, which instead will be used as image alt and title tags.'
                )
            ),
			mygcel13(
				'input',
				{ type:'text', placeholder:'Submit button image URL', value: submit_image, onChange: updateMessage18x, className: 'coderevolution_gutenberg_input' }
			),
            mygcel13(
				'br'
			),
            mygcel13(
				'label',
				{ className: 'coderevolution_gutenberg_label' },
                'Form Input Submit Button Full Width: '
			),
            mygcel13(
                'div', 
                {className:'bws_help_box bws_help_box_right dashicons dashicons-editor-help'}
                ...
                mygcel13(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Select if you want to show a full width submit button.'
                )
            ),
            mygcel13(
                'select',
                { value: submit_full, onChange: updateMessage18y, className: 'coderevolution_gutenberg_select' }, 
                mygcel13(
                    'option',
                    { value: 'off'},
                    'off'
