		...
		return mygcel12(
            ...
            mygcel12(
                ...
                mygcel12(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Set the submit button image URL. If you want to use the default submit button, leave this field empty.'
                )
            ),
			mygcel12(
				'input',
            ...
            mygcel12(
                ...
                mygcel12(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Select if you want to display full width input buttons.'
                )
            ),
            mygcel12(
                'select',
