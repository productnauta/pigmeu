"use strict"; 
const { registerBlockType: customRegisterBlockType100 } = wp.blocks;
const mygcel300 = wp.element.createElement;

customRegisterBlockType100( 'aiomatic-automatic-ai-content-writer/aiomatic-stable-image-editor', {
    title: 'AIomatic Stable Diffusion Image Editor Form',
    icon: 'text',
    category: 'embed',
    attributes: {
        image_size : {
    ...
    edit: (function( props ) {
		...
		return mygcel300(
            ...
            mygcel300(
                ...
                'AIomatic Stable Diffusion Image Editor Form ',
                mygcel300(
                    'div', 
