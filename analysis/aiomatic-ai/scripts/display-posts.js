"use strict"; 
const { registerBlockType: customRegisterBlockTypex } = wp.blocks;
const mygcel1 = wp.element.createElement;

customRegisterBlockTypex( 'aiomatic-automatic-ai-content-writer/aiomatic-display', {
    title: 'AIomatic Display Posts',
    icon: 'text',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['display', 'posts', 'aiomatic'],
    edit: (function( props ) {
