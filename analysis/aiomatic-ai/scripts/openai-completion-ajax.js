...
function openaifunct() {
    ...
    var model = aiomatic_completition_ajax_object_cmp.model;
    var temp = aiomatic_completition_ajax_object_cmp.temp;
    var top_p = aiomatic_completition_ajax_object_cmp.top_p;
    var presence = aiomatic_completition_ajax_object_cmp.presence;
    var frequency = aiomatic_completition_ajax_object_cmp.frequency;
    var user_token_cap_per_day = aiomatic_completition_ajax_object_cmp.user_token_cap_per_day;
    var user_id = aiomatic_completition_ajax_object_cmp.user_id;
    ...
    jQuery.ajax({
        type: 'POST',
        url: aiomatic_completition_ajax_object_cmp.ajax_url,
        data: {
            action: 'aiomatic_form_submit',
            input_text: input_text,
            nonce: aiomatic_completition_ajax_object_cmp.nonce,
            model: model,
