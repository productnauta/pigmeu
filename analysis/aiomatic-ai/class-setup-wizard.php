...
class Aiomatic_Setup_Wizard {
    ...
    <?php
                        ...
                        <input name="aiomatic_nonce_setup" type="hidden" value="<?php echo esc_html(wp_create_nonce('openai-secret-nonce'));?>">
                        </p>
                        <?php
                           }
...
<?php
                  ...
                  <tr>
                     ...
                     <input name="aiomatic_nonce_setup" type="hidden" value="<?php echo esc_html(wp_create_nonce('openai-secret-nonce'));?>"></td>
                  </tr>
                  <tr>
...
public function setup_step_content() {
        ...
        <ul>
            <li>
            <b><?php esc_html_e( 'Content Types:', 'aiomatic-automatic-ai-content-writer' ); ?></b>&nbsp;<?php esc_html_e( 'Generate diverse content types including posts for social media like Facebook, X (formerly Twitter), Threads, Instagram, Pinterest, YouTube Community, LinkedIn, and Reddit.', 'aiomatic-automatic-ai-content-writer' ); ?>
            </li>
            <li>
...
public function setup_step_forms() {
        ...
        <ul>
            <li>
            <b><?php esc_html_e( 'Form Types:', 'aiomatic-automatic-ai-content-writer' ); ?></b>&nbsp;<?php esc_html_e( 'Choose from text, Dall-E image, Midjourney, Replicate, Ideogram or Stable Diffusion image forms.', 'aiomatic-automatic-ai-content-writer' ); ?>
            </li>
            <li>
...
public function setup_step_api() {
    ...
    if (isset($aiomatic_Main_Settings['custom_endpoint'])) {
        ...
        <form method="post">
            <input name="aiomatic_nonce_rand" type="hidden" value="<?php echo esc_html(wp_create_nonce('openai-secret-nonce'));?>">
            <table class="form-table">
            ...
            <td>
               <div>
                  <input type="url" class="cr_width_full" autocomplete="off" id="custom_endpoint" name="aiomatic_Main_Settings[custom_endpoint]" placeholder="<?php echo esc_html__("Custom OpenAI Compatible API Base URL", 'aiomatic-automatic-ai-content-writer');?>" value="<?php echo esc_attr($custom_endpoint);?>">
               </div>
            </td>
            </tr>
                  <tr class="azurehide">
   ...
   <tr class="azurehide">
       <td>
           <div>
               ...
               <span><?php echo esc_html__("Azure OpenAI Deployment Name For '", 'aiomatic-automatic-ai-content-writer') . esc_html($model) . "':";?></span>   
           </div>
       </td>
       <td>
           <div>
...
public function setup_step_more() {
        ...
        <ul>
            ...
            <ul>
                ...
                <li>
                <?php esc_html_e( 'Membership Integration: Utilize integration with the \'Ultimate Membership Pro\' plugin, \'Paid Memberships Pro\' plugin or the \'Restrict Content Pro\' to set varying limits for different membership levels.', 'aiomatic-automatic-ai-content-writer' ); ?>
                </li>
            </ul>
            </li>
            <li>
        ...
        <ul>
            ...
            <li>
            <b><?php esc_html_e( 'Social Sharing:', 'aiomatic-automatic-ai-content-writer' ); ?></b>&nbsp;<?php esc_html_e( 'Adds multiple chatbot extension & OmniBlock extensions for sharing on various social networks, like: Facebook, Twitter, Threads, Instagram, Pinterest, LinkedIn, Reddit, YouTube Community.', 'aiomatic-automatic-ai-content-writer' ); ?>
            </li>
        </ul>
        <p><b><?php esc_html_e( 'Watch a Tutorial for this feature:', 'aiomatic-automatic-ai-content-writer' ); ?></b></p>
        ...
        <h3 class="ai-section-title"><?php esc_html_e( '\'Paid Memberships Pro\' Integration', 'aiomatic-automatic-ai-content-writer' ); ?></h3>
        <p><b><?php esc_html_e( 'Location:', 'aiomatic-automatic-ai-content-writer' ); ?></b>&nbsp;<a href="<?php echo esc_url_raw( admin_url('admin.php?page=aiomatic_openai_status#tab-2') );?>" target="_blank"><?php esc_html_e( 'AI Usage Limits tab', 'aiomatic-automatic-ai-content-writer' ); ?></a></p>
        <p><?php esc_html_e( 'Provide alternative features for your membership sites:', 'aiomatic-automatic-ai-content-writer' ); ?></p>
        <ul>
            <li>
...
public function setup_step_playground() {
        ...
        <p><b><?php esc_html_e( 'Image Generation Using DALL-E 2, DALL-E 3, Midjourney, Replicate, Ideogram and Stable Diffusion', 'aiomatic-automatic-ai-content-writer' ); ?></b></p>
        ...
        <p><?php esc_html_e( 'Generate images from text prompts using state-of-the-art models like DALL-E 2, Midjourney, Replicate, Ideogram and Stable Diffusion. Input a descriptive prompt, and the AI will create a corresponding image.', 'aiomatic-automatic-ai-content-writer' ); ?></p>
