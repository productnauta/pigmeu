...
function aiomatic_omniblocks_default_block_types() 
{
    ...
    $all_blocks = apply_filters('aiomniblocks_block_types', [
        ...
        'google_ai_image' => [
            'id' => 'google_ai_image',
            'name' => esc_html__('AI Image Google', 'aiomatic-automatic-ai-content-writer'),
            'category' => esc_html__(' - AI Content Blocks', 'aiomatic-automatic-ai-content-writer'),
            'required_plugin' => array(),
            'description' => esc_html__('Generates AI images using different Google models', 'aiomatic-automatic-ai-content-writer'),
            'type' => 'create',
            'shortcodes' => array('google_image_'),
            'parameters' => array(
                'prompt' => array(
                    'type' => 'textarea',
                    'title' => esc_html__('AI Prompt', 'aiomatic-automatic-ai-content-writer'),
                ...
                'model' => array(
                    'type' => 'google_image_model_select',
                    'title' => esc_html__('AI Model', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => '',
                    'description' => esc_html__('Set the AI model to be used for the image generator.', 'aiomatic-automatic-ai-content-writer')
                )
        ...
        'ideogram_ai_image' => [
            'id' => 'ideogram_ai_image',
            'name' => esc_html__('AI Image Ideogram', 'aiomatic-automatic-ai-content-writer'),
            'category' => esc_html__(' - AI Content Blocks', 'aiomatic-automatic-ai-content-writer'),
            'required_plugin' => array(),
            'description' => esc_html__('Generates AI images using different Ideogram models', 'aiomatic-automatic-ai-content-writer'),
            'type' => 'create',
            'shortcodes' => array('ideogram_image_'),
            'parameters' => array(
                'prompt' => array(
                    'type' => 'textarea',
                    'title' => esc_html__('AI Prompt', 'aiomatic-automatic-ai-content-writer'),
                ...
                'image_size' => array(
                    'type' => 'ideogram_image_size_select',
                    'title' => esc_html__('Image Size', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => '',
                    'description' => esc_html__('Set the image size to be used for the image generator.', 'aiomatic-automatic-ai-content-writer')
                )
        ...
        'stt_openai' => [
            'id' => 'stt_openai',
            'name' => esc_html__('Speech-To-Text - OpenAI', 'aiomatic-automatic-ai-content-writer'),
            'category' => esc_html__(' - Content Gathering Blocks', 'aiomatic-automatic-ai-content-writer'),
            'required_plugin' => array(),
            'description' => esc_html__('Using OpenAI API, transforms speech to text.', 'aiomatic-automatic-ai-content-writer'),
            'type' => 'create',
            'shortcodes' => array('audio_transcript_'),
            'parameters' => array(
                'audio_url' => array(
                    'type' => 'text',
                    'title' => esc_html__('Audio URL', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => '',
                    'placeholder' => esc_html__('Speech URL to be transformed into text', 'aiomatic-automatic-ai-content-writer'),
                    'description' => esc_html__('Please provide the speech URL which will be transformed into text. Supported formats are: mp3, mp4, mpeg, m4a, wav, webm', 'aiomatic-automatic-ai-content-writer')
                ),
                'prompt' => array(
                    'type' => 'text',
                    'title' => esc_html__('Prompt', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => '',
                    'placeholder' => esc_html__('Add instructions to the AI', 'aiomatic-automatic-ai-content-writer'),
                    'description' => esc_html__('Provide instructions for the AI using this prompt', 'aiomatic-automatic-ai-content-writer')
                ),
                'purpose' => array(
                    'type' => 'select',
                    'values' => array("transcriptions" => "transcriptions", "translations" => "translations"),
                    'title' => esc_html__('Purpose', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => 'transcriptions',
                    'description' => esc_html__('Set the purpose of the operation.', 'aiomatic-automatic-ai-content-writer')
                ),
                'model' => array(
                    'type' => 'select',
                    'values' => array("whisper-1" => "whisper-1", "gpt-4o-mini-transcribe" => "gpt-4o-mini-transcribe", "gpt-4o-transcribe" => "gpt-4o-transcribe"),
                    'title' => esc_html__('AI Model Selector', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => 'whisper-1',
                    'description' => esc_html__('Select the model to be used when generating the speech to text.', 'aiomatic-automatic-ai-content-writer')
                ),
                'language' => array(
                    'type' => 'text',
                    'title' => esc_html__('Language', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => 'en',
                    'placeholder' => esc_html__('Set the language to be used', 'aiomatic-automatic-ai-content-writer'),
                    'description' => esc_html__('Provide the 2 letter language which will be used for this action', 'aiomatic-automatic-ai-content-writer')
                ),
                'temperature' => array(
                    'type' => 'number',
                    'title' => esc_html__('Temperature', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => '0',
                    'placeholder' => esc_html__('0', 'aiomatic-automatic-ai-content-writer'),
                    'description' => esc_html__('Select a the temperature for the AI action.', 'aiomatic-automatic-ai-content-writer')
                )
            )
        ],
        'webhook_fire' => [
            ...
            'category' => esc_html__(' - Trigger Blocks', 'aiomatic-automatic-ai-content-writer'),
            'required_plugin' => array(),
        ...
        'ai_forms_omniblock' => [
            'id' => 'ai_forms_omniblock',
            'name' => esc_html__('AI Forms Trigger', 'aiomatic-automatic-ai-content-writer'),
            'category' => esc_html__(' - Trigger Blocks', 'aiomatic-automatic-ai-content-writer'),
            'required_plugin' => array(),
            'description' => esc_html__('Using data submitted by an AI Form, run OmniBlock rules automatically, even when not scheduled.', 'aiomatic-automatic-ai-content-writer'),
            'type' => 'create',
            'shortcodes' => array('ai_forms_full_input_'),
            'parameters' => array(
                'api_key' => array(
                    'type' => 'text',
                    'title' => esc_html__('Trigger API Key', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => '',
                    'placeholder' => esc_html__('Set your API own API key which will allow access to your trigger', 'aiomatic-automatic-ai-content-writer'),
                    'description' => esc_html__('Set your API own API key which will allow access to your trigger. This will prevent unauthorized requests from accessing the webhook.', 'aiomatic-automatic-ai-content-writer')
                )
            )
        ],
        'ai_chatbot_omniblock' => [
            'id' => 'ai_chatbot_omniblock',
            'name' => esc_html__('AI Chatbot Trigger', 'aiomatic-automatic-ai-content-writer'),
            'category' => esc_html__(' - Trigger Blocks', 'aiomatic-automatic-ai-content-writer'),
            'required_plugin' => array(),
            'description' => esc_html__('Using data submitted by the AI Chatbot, run OmniBlock rules automatically, even when not scheduled.', 'aiomatic-automatic-ai-content-writer'),
            'type' => 'create',
            'shortcodes' => array('ai_chatbot_full_input_'),
            'parameters' => array(
            )
        ],
        'wp_event_trigger' => [
            'id' => 'wp_event_trigger',
            'name' => esc_html__('WordPress Event Trigger', 'aiomatic-automatic-ai-content-writer'),
            'category' => esc_html__(' - Trigger Blocks', 'aiomatic-automatic-ai-content-writer'),
            'required_plugin' => [],
            'description' => esc_html__('Triggers OmniBlocks automatically on selected WordPress events.', 'aiomatic-automatic-ai-content-writer'),
            'type' => 'create',
            'shortcodes' => ['event_param1_', 'event_param2_', 'event_param3_', 'event_param4_', 'event_param5_', 'event_param6_', 'event_param7_', 'event_param8_', 'event_param9_', 'event_param10_'],
            'parameters' => [
                'wp_event' => [
                    'type' => 'select',
                    'title' => esc_html__('WordPress Event', 'aiomatic-automatic-ai-content-writer'),
                    'values' => [
                        'publish_post'            => 'Post Published',
                        'save_post'               => 'Post Saved (Any Status)',
                        'post_updated'            => 'Post Updated',
                        'trash_post'              => 'Post Moved to Trash',
                        ...
                        'edit_user_profile_update' => 'User Profile Edited from Admin',

                        'comment_post'            => 'Comment Submitted',
                        'wp_insert_comment'       => 'Comment Inserted',
                        'edit_comment'            => 'Comment Edited',
                        'comment_unapproved_to_approved' => 'Comment Approved',
                        'comment_approved_to_unapproved' => 'Comment Unapproved',
                        'spam_comment'                   => 'Comment Marked as Spam',
                        'delete_comment'          => 'Comment Deleted',

                        'add_attachment'          => 'Media Attachment Uploaded',
                        'delete_attachment'       => 'Media Attachment Deleted',
                        'attachment_updated'      => 'Media Attachment Updated',
                        'wp_handle_upload'        => 'Media File Uploaded via Upload Handler',

                        'woocommerce_thankyou'    => 'WooCommerce Order Placed',
                        'woocommerce_order_status_completed' => 'WooCommerce Order Completed',
                        'woocommerce_order_status_cancelled' => 'WooCommerce Order Cancelled',
                        ...
                        'woocommerce_customer_save_address'     => 'Customer Updated Address',
                        'woocommerce_new_customer'              => 'New Customer Registered',

                        'wpcf7_mail_sent'         => 'Contact Form 7 Sent',
                        'gform_after_submission'  => 'Gravity Forms Submitted',

                        'activated_plugin'        => 'Plugin Activated',
                        'deactivated_plugin'      => 'Plugin Deactivated',
                        'switch_theme'            => 'Theme Switched',
                        'upgrader_process_complete' => 'Plugin/Theme/WordPress Updated',
                        'after_switch_theme'      => 'Theme Activated (after switch)',

                        'aiomatic_custom_event'   => 'Custom Aiomatic Event (aiomatic_custom_event)',
                        'aiomatic_custom_event2'   => 'Custom Aiomatic Event 2 (aiomatic_custom_event2)',
                        'aiomatic_custom_event3'   => 'Custom Aiomatic Event 3 (aiomatic_custom_event3)',
                        'aiomatic_custom_event4'   => 'Custom Aiomatic Event 4 (aiomatic_custom_event4)',
                        'aiomatic_custom_event5'   => 'Custom Aiomatic Event 5 (aiomatic_custom_event5)',
                        'aiomatic_custom_event6'   => 'Custom Aiomatic Event 6 (aiomatic_custom_event6)',
                    ],
                    'default_value' => 'publish_post',
                    'description' => esc_html__('Choose the WordPress event that will trigger this OmniBlock.', 'aiomatic-automatic-ai-content-writer')
                ]
            ]
        ],
        'post_import' => [
        ...
        'wait_block' => [
            'id' => 'wait_block',
            'name' => esc_html__('Waits for the specified amount of time', 'aiomatic-automatic-ai-content-writer'),
            'category' => esc_html__(' - Logic Blocks', 'aiomatic-automatic-ai-content-writer'),
            'required_plugin' => array(),
            'description' => esc_html__('This OmniBlock will add a delay in the execution logic of your OmniBlock queue.', 'aiomatic-automatic-ai-content-writer'),
            'type' => 'create',
            'shortcodes' => array(),
            'parameters' => array(
                'wait' => array(
                    'type' => 'textarea',
                    'title' => esc_html__('Delay Time', 'aiomatic-automatic-ai-content-writer'),
                    'default_value' => '',
                    'placeholder' => esc_html__('1 minute', 'aiomatic-automatic-ai-content-writer'),
                    'description' => esc_html__('Add a time delay for how long should the plugin wait. You can use natural language, examples: 1 minute, 1 second, 1 hour, 1 day, etc. You can also add a comma separated list of values, in this case, a random value will be selected at each run.', 'aiomatic-automatic-ai-content-writer')
                )
            )
        ],
        'jump_block' => [
...
function aiomatic_add_block_types($block_types) 
{
    ...
    $block_types['send_threads'] = [
        'id' => 'send_threads',
        'name' => 'Send To Threads',
        'category' => esc_html__(' - Content Saving Blocks', 'aiomatic-automatic-ai-content-writer'),
        'required_plugin' => array('threadsomatic-threads-auto-poster/threadsomatic-threads-auto-poster.php' => array('Threadsomatic Threads Auto Poster', 'https://wpbay.com/product/threadsomatic-threads-auto-poster/')),
        'description' => esc_html__('Sends posts to Threads pages', 'aiomatic-automatic-ai-content-writer'),
        'type' => 'save',
        'shortcodes' => array(),
        'parameters' => array(
            'post_template' => array(
                'type' => 'textarea',
                'title' => esc_html__('Threads Post Template', 'aiomatic-automatic-ai-content-writer'),
                'default_value' => '',
                'placeholder' => esc_html__('Set the main Threads post content', 'aiomatic-automatic-ai-content-writer'),
                'description' => esc_html__('Set the main Threads post content. Additional shortcodes you can use: %%current_date_time%%, %%custom_html%%, %%custom_html2%%, %%random_sentence%%, %%random_sentence2%% + Spintax, Synergy shortcodes, [aicontent] shortcodes and WordPress shortcodes supported.', 'aiomatic-automatic-ai-content-writer')
            ),
            'featured_image' => array(
                'type' => 'url',
                'title' => esc_html__('Threads Post Image URL', 'aiomatic-automatic-ai-content-writer'),
                'default_value' => '',
                'placeholder' => esc_html__('Set the link of the Threads post image', 'aiomatic-automatic-ai-content-writer'),
                'description' => esc_html__('Set the link of the Threads post image. Additional shortcodes you can use: %%current_date_time%%, %%custom_html%%, %%custom_html2%%, %%random_sentence%%, %%random_sentence2%% + Spintax, Synergy shortcodes, [aicontent] shortcodes and WordPress shortcodes supported.', 'aiomatic-automatic-ai-content-writer')
            )
        )
    ];
