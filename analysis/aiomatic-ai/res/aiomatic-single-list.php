...
<div id="aiomatic-dialog" class="hidden">
  ...
  <p class="aiomatic-middle"><button id="aiomatic-success-button" adminurl="<?php echo esc_url(admin_url('post.php?post='));?>" postid=""><?php echo esc_html__("Edit Created Post", 'aiomatic-automatic-ai-content-writer');?></button></p>
...
?>
<form name="aiomatic-single-post" action="<?php echo esc_url((aiomatic_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");?>" method="post" id="aiomatic-single-post">
<div id="poststuff">
...
<thead>
<tr>
<th class="left"><label for="metakeyinput"><?php echo esc_html__("Name", 'aiomatic-automatic-ai-content-writer');?></label></th>
...
else
{
	...
	if(is_array($aiomatic_templates))
	{
		...
		{
			echo '<option value="' . esc_html($tn) . '">' . esc_html($tn) . '</option>';
		}
	}
}
?>
...
?>
							<input type="datetime-local" id="post_date" name="post_date" value="<?php echo esc_html($date1x->format('Y-m-d H:i:s')); ?>" class="coderevolution_gutenberg_input" />
					<div class="clear"></div>
					<div class="cr-align-left">
...
if(!is_wp_error($xtags))
{
	foreach ($xtags as $tag) {
		echo '<option>' . esc_html($tag->name) . '</option>';
	}
}
?>
							</datalist>
...
<div id="minor-publishing">
	<div class="aiomatic-minor-publishing-actions">
<?php
echo '<div class="coderevolution_gutenberg_input"><img id="aiomatic-preview-image"/></div>';?>
...
<div id="other-publishing">
	...
	<input type="number" min="1" step="1" name="max_tokens" id="max_tokens" class="coderevolution_gutenberg_input" value="4000" placeholder="Max Tokens">
   <div class="clear"></div>
					<div class="cr-align-left">
...
<hr class="wp-header-end">
<form name="aiomatic-single-post-advanced" action="<?php echo esc_url((aiomatic_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");?>" method="post" id="aiomatic-single-post-advanced">
<div id="poststuff">
<div id="post-body" class="metabox-holder columns-2">
<div id="post-body-content">
...
?>
                        ...
                        <tr class="hidetopic">
                           ...
                           <td>
                           <input type="number" min="0" name="topic_videos" id="topic_videos6" value="" placeholder="Number of social embeds" class="valuesai6 cr_width_full">
                           </td>
                        </tr>
                        <tr class="hidetopic">
                           <td>
...
<option value="excerpt">excerpt</option>
                     ...
                     <tr><td colspan="2">
                        ...
                        <tr>
                           ...
                           <td>
                           <input type="number" min="1" name="max_tokens" id="max_tokens6" value="" placeholder="32768" class="valuesai6 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_seed_tokens" id="max_seed_tokens6" value="" placeholder="1000" class="valuesai6 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
...
?>
                        ...
                        <tr class="hidetopic">
                           ...
                           <td>
                           <input type="number" min="0" name="topic_videos" id="topic_videos1a" value="" placeholder="Number of social embeds" class="valuesai1a cr_width_full">
                           </td>
                        </tr>
                        <tr class="hidetopic">
                           <td>
...
<option value="excerpt">excerpt</option>
                     ...
                     <tr><td colspan="2">
                        ...
                        <tr>
                           ...
                           <td>
                           <input type="number" min="1" name="max_tokens" id="max_tokens1a" value="" placeholder="32768" class="valuesai1a cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_seed_tokens" id="max_seed_tokens1a" value="" placeholder="1000" class="valuesai1a cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
...
?>
                     ...
                     <tr><td colspan="2">
                        ...
                        <tr>
                           ...
                           <td>
                           <input type="number" min="1" name="max_tokens" id="max_tokens1b" value="" placeholder="32768" class="valuesai1b cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_seed_tokens" id="max_seed_tokens1b" value="" placeholder="1000" class="valuesai1b cr_width_full">
                           </td>
                        </tr>
                        <tr class="hidetitle">
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_continue_tokens" id="max_continue_tokens1b" value="" placeholder="500" class="valuesai1b cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                     ...
                     <tr><td colspan="2">
                        ...
                        <tr class="hideImg1b cr_none">
                           ...
                           <td class="cr_min_width_200">
                           <select autocomplete="off" id="image_size1b" name="image_size" class="valuesai1b cr_width_full">
                              <option value="256x256"><?php echo esc_html__("256x256", 'aiomatic-automatic-ai-content-writer');?></option>
                              <option value="512x512"><?php echo esc_html__("512x512", 'aiomatic-automatic-ai-content-writer');?></option>
                              <option value="1024x1024" selected><?php echo esc_html__("1024x1024", 'aiomatic-automatic-ai-content-writer');?></option>
                           </select>  
...
<option value="excerpt">excerpt</option>
                     ...
                     <tr><td colspan="2">
                        ...
                        <tr>
                           ...
                           <td>
                           <input type="number" min="1" name="max_tokens" id="max_tokens2" value="" placeholder="2048" class="valuesai2 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_seed_tokens" id="max_seed_tokens2" value="" placeholder="1000" class="valuesai2 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_continue_tokens" id="max_continue_tokens2" value="" placeholder="500" class="valuesai2 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
...
<option value="table">table</option>
                     ...
                     <tr><td colspan="2">
                        ...
                        <tr>
                           ...
                           <td>
                           <input type="number" min="1" name="max_tokens" id="max_tokens3" value="" placeholder="2048" class="valuesai3 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_seed_tokens" id="max_seed_tokens3" value="" placeholder="1000" class="valuesai3 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_continue_tokens" id="max_continue_tokens3" value="" placeholder="500" class="valuesai3 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
...
<option value="excerpt">excerpt</option>
                     ...
                     <tr><td colspan="2">
                        ...
                        <tr>
                           ...
                           <td>
                           <input type="number" min="1" name="max_tokens" id="max_tokens4" value="" placeholder="2048" class="valuesai4 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_seed_tokens" id="max_seed_tokens4" value="" placeholder="1000" class="valuesai4 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
                           ...
                           <td>
                           <input type="number" min="1" name="max_continue_tokens" id="max_continue_tokens4" value="" placeholder="500" class="valuesai4 cr_width_full">
                           </td>
                        </tr>
                        <tr>
                           <td class="cr_min_width_200">
...
$date1x = new DateTime('now', aiomatic_get_blog_timezone());
?>
							<input type="datetime-local" id="post_date_advanced" name="post_date_advanced" value="<?php echo esc_html($date1x->format('Y-m-d H:i:s')); ?>" class="coderevolution_gutenberg_input" />
					<div class="clear"></div>
					<div class="cr-align-left">
	<div class="tool" data-tip="Set the post categories."><?php echo esc_html__("Post Categories", 'aiomatic-automatic-ai-content-writer');?>:&nbsp;&#9072;
                              </div>
...
<div id="minor-publishing">
	<div class="aiomatic-minor-publishing-actions">
<?php
echo '<div class="coderevolution_gutenberg_input"><img id="aiomatic-preview-image-advanced"/></div>';?>
