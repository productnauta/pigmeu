...
?>
    ...
    &quot;required&quot;: [
      &quot;location&quot;
        ...
        <input type='checkbox' class="god_mode-checkbox" id="function_toubiz"<?php if(!$toubiz_active){echo ' disabled title="Required plugin (Aiomatic Extension Toubiz API) not activated"';}?>/><label for="function_toubiz"><?php echo esc_html__( 'Toubiz API Integration', 'aiomatic-automatic-ai-content-writer' ); ?></label>&nbsp;
...
?>
    ...
    &quot;required&quot;: [
      &quot;location&quot;
        ...
        <input type='checkbox' class="god_mode-edit-checkbox" id="function_toubiz-edit"<?php if(!$toubiz_active){echo ' disabled title="Required plugin (Aiomatic Extension Toubiz API) not activated"';}?>/><label for="function_toubiz-edit"><?php echo esc_html__( 'Toubiz API Integration', 'aiomatic-automatic-ai-content-writer' ); ?></label>&nbsp;
