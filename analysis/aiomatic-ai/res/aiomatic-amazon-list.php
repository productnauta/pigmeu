...
<div class="wrap gs_popuptype_holder seo_pops">
   <div>
      <form id="myForm" method="post" action="<?php echo esc_html((aiomatic_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");?>">
         <?php
...
?>
                                             ...
                                             <option value="<?php
                                                ...
                                                ?>"><?php
                                                echo esc_html(sanitize_text_field($category->name) . ' - ID ' . $category->term_id);
                                                ?></option>
                                             <?php
                                                }
                                                ?>
...
?>
                                          ...
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_amazon_list[max_tokens][]" value="" placeholder="2048" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_amazon_list[max_seed_tokens][]" value="" placeholder="1000" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_amazon_list[max_continue_tokens][]" value="" placeholder="500" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                          ...
                                          <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="default_type" name="aiomatic_amazon_list[default_type][]" class="cr_width_full" onchange="go_change_cats(this, '');">
                                                <?php
                                                   $is_first = true;
                           ...
                           <input type="hidden" name="aiomatic_amazon_list[rule_unique_id][]" value="<?php echo esc_html(uniqid('', true));?>"/>
                           </td>
...
<div class="wrap">
        ...
        <div id="ai-video-container"><br/>
            <iframe class="ai-videoecho" width="560" height="315" src="https://www.youtube.com/embed/li3UhcGpVc0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
<?php
   }
...
$output .= '</select>  
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select id="source' . esc_html($cont) . '" name="aiomatic_amazon_list[target_country][]" class="cr_width_full">';
                        foreach ($amaz_countries as $key => $value) {
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="0" step="1" id="min_price' . esc_html($cont) . '" name="aiomatic_amazon_list[min_price][]" value="' . esc_attr($min_price) . '" class="cr_width_full" placeholder="Input a minimum price">
         </div>
         </td></tr><tr><td>
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="0" step="1" id="max_price' . esc_html($cont) . '" name="aiomatic_amazon_list[max_price][]" value="' . esc_attr($max_price) . '" class="cr_width_full" placeholder="Input a maximum price">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select id="sort_results' . esc_html($cont) . '" name="aiomatic_amazon_list[sort_results][]" class="cr_width_full">
                     <option value="none"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="shuffle_products' . esc_html($cont) . '" name="aiomatic_amazon_list[shuffle_products][]"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="first_hand' . esc_html($cont) . '" name="aiomatic_amazon_list[first_hand][]"';
         if($first_hand == '1')
         {
             $output .= ' checked';
         }
         ...
         <tr><td>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" class="cr_width_full" id="sections_role' . esc_html($cont) . '" name="aiomatic_amazon_list[sections_role][]">
                       <option value="h2"';
               if ($sections_role == 'h2') {
                   $output .= ' selected';
               }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="topic_images' . esc_html($cont) . '" name="aiomatic_amazon_list[topic_images][]"';
         if($topic_images == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="no_headlink' . esc_html($cont) . '" name="aiomatic_amazon_list[no_headlink][]"';
         if($no_headlink == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="topic_videos' . esc_html($cont) . '" name="aiomatic_amazon_list[topic_videos][]"';
         if($topic_videos == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_toc' . esc_html($cont) . '" name="aiomatic_amazon_list[enable_toc][]"';
         if($enable_toc == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_qa' . esc_html($cont) . '" name="aiomatic_amazon_list[enable_qa][]"';
         if($enable_qa == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_table' . esc_html($cont) . '" name="aiomatic_amazon_list[enable_table][]"';
         if($enable_table == '1')
         {
             $output .= ' checked';
         }
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <tr><td>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" class="cr_width_full" id="auto_categories' . esc_html($cont) . '" name="aiomatic_amazon_list[auto_categories][]">
                       <option value="disabled"';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select multiple class="cr_width_full" id="default_category' . esc_html($cont) . '" name="aiomatic_amazon_list[default_category' . esc_html($cont) . '][]" onmouseover="this.size=this.length;" onmouseout="this.size=4;">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="remove_default' . esc_html($cont) . '" name="aiomatic_amazon_list[remove_default][]"';
         if($remove_default == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="skip_inexist' . esc_html($cont) . '" name="aiomatic_amazon_list[skip_inexist][]"';
         if($skip_inexist == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" class="cr_width_full" id="auto_tags' . esc_html($cont) . '" name="aiomatic_amazon_list[auto_tags][]">
                     <option value="disabled"';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_amazon_list[max_tokens][]" value="' . esc_attr($max_tokens) . '" placeholder="2048" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_amazon_list[max_seed_tokens][]" value="' . esc_attr($max_seed_tokens) . '" placeholder="1000" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_amazon_list[max_continue_tokens][]" value="' . esc_attr($max_continue_tokens) . '" placeholder="500" class="cr_width_full">
         ...
         <tr><td colspan="2"><h3>' . esc_html__('Posting Options', 'aiomatic-automatic-ai-content-writer') . ':</h3></td></tr>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="strip_title' . esc_html($cont) . '" name="aiomatic_amazon_list[strip_title][]"';
           if($strip_title == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="skip_spin' . esc_html($cont) . '" name="aiomatic_amazon_list[skip_spin][]"';
           if($skip_spin == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="skip_translate' . esc_html($cont) . '" name="aiomatic_amazon_list[skip_translate][]"';
           if($skip_translate == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="title_once' . esc_html($cont) . '" name="aiomatic_amazon_list[title_once][]"';
           if($title_once == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="overwrite_existing' . esc_html($cont) . '" name="aiomatic_amazon_list[overwrite_existing][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="post_author' . esc_html($cont) . '" name="aiomatic_amazon_list[post_author][]" class="cr_width_full">';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="submit_status' . esc_html($cont) . '" name="aiomatic_amazon_list[submit_status][]" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="default_type' . esc_html($cont) . '" name="aiomatic_amazon_list[default_type][]" class="cr_width_full" onchange="go_change_cats(this, \'' . esc_html($cont) . '\');">';
               foreach ( get_post_types( '', 'names' ) as $post_type ) {
                  if(strstr($post_type, 'aiomatic_'))
                  {
                     continue;
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="post_format' . esc_html($cont) . '" name="aiomatic_amazon_list[post_format][]" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_comments' . esc_html($cont) . '" name="aiomatic_amazon_list[enable_comments][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_pingback' . esc_html($cont) . '" name="aiomatic_amazon_list[enable_pingback][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" id="min_time' . esc_html($cont) . '" name="aiomatic_amazon_list[min_time][]" value="' . esc_attr($min_time) . '" placeholder="Start time" class="cr_half"> - <input type="text" id="max_time' . esc_html($cont) . '" name="aiomatic_amazon_list[max_time][]" value="' . esc_attr($max_time) . '" placeholder="End time" class="cr_half">   
           </div>
           </td></tr><tr><td class="cr_min_width_200">
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
       ...
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
               ...
               $output .= '" title="status">
                           ...
                           <select autocomplete="off" class="codemainfzr" id="actions' . esc_html($cont) . '" class="actions" name="actions" onchange="actionsChangedManual(' . esc_html($cont) . ', this.value, 2, \'' . esc_html($rule_unique_id) . '\');" onfocus="this.selectedIndex = 0;">
