...
if($no_tb == true)
{
    echo esc_html__("This option requires the Aiomatic Extension: Toubiz API plugin to be active.", 'aiomatic-automatic-ai-content-writer');?>
<?php
}
...
?></textarea>
    ...
    <select autocomplete="off" id="model" name="aiomatic_Chatbot_Settings[image_chat_model]" class="cr_width_full">
        ...
        <option value="gpt-image-1" <?php if($image_chat_model == 'gpt-image-1'){echo ' selected';}?> ><?php echo esc_html__("gpt-image-1", 'aiomatic-automatic-ai-content-writer');?></option>
    </select>
    </td>
    </tr>
    <tr><td colspan="2">
