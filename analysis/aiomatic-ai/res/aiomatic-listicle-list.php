<?php
   function aiomatic_listicle_panel()
   {
...
<div class="wrap">
   <h1><?php echo esc_html__("Listicle Creator", 'aiomatic-automatic-ai-content-writer');?></h1>
</div>
<?php
            ...
            <div class="hideMain">
               ...
               <div class="table-responsive">
                  <table id="mainRules" class="responsive table cr_main_table">
                     ...
                     <tbody>
                        <?php
                           echo aiomatic_expand_rules_listicle();
                        ...
                        <tr>
                           <td class="cr_short_td"><input type="text" name="aiomatic_listicle_list[rule_description][]" id="rule_description" class="cr_center" placeholder="Rule ID" value="" class="cr_width_full"/></td>
                           <td class="cr_loi"><textarea rows="1" name="aiomatic_listicle_list[post_title][]" placeholder="Please insert your post titles/TXT file URL/RSS feed URLs/%%ai_generated_title%% shortcode" class="cr_width_full"></textarea></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="1" name="aiomatic_listicle_list[schedule][]" max="8765812" class="cr_width_60" placeholder="Select the rule schedule interval" value="24"/></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="0" name="aiomatic_listicle_list[max][]" class="cr_width_60" placeholder="Select the # of generated posts" value="1" /></td>
                                       ...
                                       <div class="table-responsive">
                                          <table class="responsive table cr_main_table_nowr">
                                             ...
                                             <tr>
                                                ...
                                                <td><select id="assistant_id" name="aiomatic_listicle_list[assistant_id][]" class="cr_width_full" onchange="assistantSelected('');">
<?php
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[post_topic_list][]" placeholder="Example: 'funny dog facts', 'best houseplants', 'proven ways to save money'" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="title_generator_method" name="aiomatic_listicle_list[title_generator_method][]">
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[post_sections_list][]" placeholder="Post sections list (one per line)" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <input type="text" id="section_count" name="aiomatic_listicle_list[section_count][]" placeholder="3-4" class="cr_width_full" value="3-4">  
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="sections_role" name="aiomatic_listicle_list[sections_role][]">
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td class="cr_min_width_200">
                                                <input type="text" id="paragraph_count" name="aiomatic_listicle_list[paragraph_count][]" placeholder="2-3" class="cr_width_full" value="2">  
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_listicle_list[topic_images][]" value="" placeholder="Number of images" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="img_all_headings" name="aiomatic_listicle_list[img_all_headings][]" checked>
                                                </td>
                                             </tr> 
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="heading_img_location" name="aiomatic_listicle_list[heading_img_location][]" class="cr_width_full">
                                             ...
                                             <tr class="hidetopic">
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                               echo esc_html__("Set the number of related social embeds to add to the created post content. The maximum number of social embeds you can add to each article: number of sections You can select the source of the social embeds, in the plugin's 'Settings' menu -> 'Bulk Posts' tab -> 'Social Networks To Get Embeds From In AI Created Articles' settings field.", 'aiomatic-automatic-ai-content-writer');
                                                               ?>
                                                         </div>
                                                      </div>
                                                      <b><?php echo esc_html__("Number of Social Network Embeds To Add To The Article:", 'aiomatic-automatic-ai-content-writer');?></b>
                                                </td>
                                                <td>
                                                <input type="number" min="0" name="aiomatic_listicle_list[topic_videos][]" value="" placeholder="Number of social embeds" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td class="hideTOC-1">
                                                <input type="checkbox" id="enable_toc" name="aiomatic_listicle_list[enable_toc][]">
                                                </td>
                                             </tr> 
                                             <tr class="hidetopic">
                                                <td class="hideTOC-1">
                                                ...
                                                <td class="hideTOC-1">
                                                <input type="text" name="aiomatic_listicle_list[title_toc][]" value="Table of Contents" placeholder="Table of Contents" class="cr_width_full">
                                                </td>
                                             </tr> 
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="enable_qa" name="aiomatic_listicle_list[enable_qa][]">
                                                </td>
                                             </tr> 
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_listicle_list[title_qa][]" value="Q&A" placeholder="Q&A" class="cr_width_full">
                                                </td>
                                             </tr> 
                                             <tr class="hidetopic"><td colspan="2">
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <input id="content_language" name="aiomatic_listicle_list[content_language][]" type="text" list="languages" placeholder="Created content language" class="coderevolution_gutenberg_input" value="English"/>
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <input id="writing_style" name="aiomatic_listicle_list[writing_style][]" type="text" placeholder="Created content writing style" list="writing_styles" class="coderevolution_gutenberg_input" value="Creative"/>
...
<option>Research</option>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <input id="writing_tone" name="aiomatic_listicle_list[writing_tone][]" type="text" list="writing_tones" placeholder="Created content writing tone" class="coderevolution_gutenberg_input" value="Neutral"/>
...
<option>Serious</option>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[title_prompt][]" placeholder="Enter your title prompts, one per line" class="cr_width_full">Write a title for a listicle about "%%topic%%" in %%language%%. The listicle will include %%sections_count%% items. Style: %%writing_style%%. Tone: %%writing_tone%%. Include a specific number in the title to indicate a list. Must be between 40 and 60 characters.</textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_title_model" name="aiomatic_listicle_list[topic_title_model][]" class="hideAssistant cr_width_full">
                                                <?php
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[intro_prompt][]" placeholder="Enter your intro prompts, one per line" class="cr_width_full">Craft an introduction for a listicle about "%%title%%", in %%language%%. Style: %%writing_style%%. Tone: %%writing_tone%%. Highlight the number of items in the list (%%sections_count%% items) and what the reader can expect to learn or gain from the listicle.</textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_intro_model" name="aiomatic_listicle_list[topic_intro_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[sections_prompt][]" placeholder="Enter your sections prompts, one per line" class="cr_width_full">Write %%sections_count%% consecutive entries for a listicle about "%%title%%". The entries must be written in %%language%%, following a %%writing_style%% style and a %%writing_tone%% tone. Don't use HTML in your response, write only plain text entries, one on each line, as I will use these entries to further create content for each of them. Return only the entries, nothing else. Add numbers to created entries, in this format: 1)</textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_sections_model" name="aiomatic_listicle_list[topic_sections_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_content_model" name="aiomatic_listicle_list[topic_content_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <input type="checkbox" id="single_content_call-1" name="aiomatic_listicle_list[single_content_call][]" onclick="hideTOC(-1);">
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td class="cr_min_width_200">
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_qa_model" name="aiomatic_listicle_list[topic_qa_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[outro_prompt][]" placeholder="Enter your outro prompts, one per line" class="cr_width_full">Write an outro for a listicle about "%%title%%", in %%language%%. Style: %%writing_style%%. Tone: %%writing_tone%%.</textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_outro_model" name="aiomatic_listicle_list[topic_outro_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[excerpt_prompt][]" placeholder="Enter your excerpt prompts, one per line" class="cr_width_full">Write a short excerpt for a listicle about "%%title%%" in %%language%%. Style: %%writing_style%%. Tone: %%writing_tone%%. Must be between 150 and 250 characters. Highlight the listicle nature of the article and what readers can expect to find.</textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_excerpt_model" name="aiomatic_listicle_list[topic_excerpt_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr class="hidetopic">
                                                ...
                                                <td>
                                                <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[strip_by_regex_prompts][]" placeholder="regex expression" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td>
                                                <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[replace_regex_prompts][]" placeholder="regex replacement" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
                                                ...
                                                <td>
                                                <input id="run_regex_on" name="aiomatic_listicle_list[run_regex_on][]" type="text" list="run_regex_on_list" class="coderevolution_gutenberg_input" value="content"/>
                     ...
                     <option value="excerpt">excerpt</option>
                                          ...
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[global_prepend][]" placeholder="Global prompt prepend text" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[global_append][]" placeholder="Global prompt append text" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="link_type" onchange="hideLinks('');" name="aiomatic_listicle_list[link_type][]">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_listicle_list[max_links][]" placeholder="Add the number of links to enable this feature" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr class="hidelinks">
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="1" cols="70" name="aiomatic_listicle_list[link_list][]" placeholder="URL list (one per line)" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidelinks">
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="checkbox" id="link_nofollow" name="aiomatic_listicle_list[link_nofollow][]">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_listicle_list[link_post_types][]" placeholder="post" class="cr_width_full">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="auto_categories" name="aiomatic_listicle_list[auto_categories][]">
                                                <option value="disabled" selected><?php echo esc_html__("Disabled", 'aiomatic-automatic-ai-content-writer');?></option>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="category_model" name="aiomatic_listicle_list[category_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                             <select multiple id="default_category" name="aiomatic_listicle_list[default_category][]" class="cr_width_full" onmouseover="this.size=this.length;" onmouseout="this.size=4;">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="checkbox" id="remove_default" name="aiomatic_listicle_list[remove_default][]" checked>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="skip_inexist" name="aiomatic_listicle_list[skip_inexist][]">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="auto_tags" name="aiomatic_listicle_list[auto_tags][]">
                                                <option value="disabled" selected><?php echo esc_html__("Disabled", 'aiomatic-automatic-ai-content-writer');?></option>
                                                <option value="ai"><?php echo esc_html__("AI Generated", 'aiomatic-automatic-ai-content-writer');?></option>
                                                <option value="hashtags"><?php echo esc_html__("Title", 'aiomatic-automatic-ai-content-writer');?></option>
                                                <option value="content"><?php echo esc_html__("Content", 'aiomatic-automatic-ai-content-writer');?></option>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="tag_model" name="aiomatic_listicle_list[tag_model][]" class="hideAssistant cr_width_full">
<?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_listicle_list[default_tags][]" value="" placeholder="Please insert your additional post tags here" class="cr_width_full">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_listicle_list[max_tokens][]" value="" placeholder="32768" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_listicle_list[max_seed_tokens][]" value="" placeholder="1000" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="0" step="0.01" max="2" name="aiomatic_listicle_list[temperature][]" value="" placeholder="1" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="0" max="1" step="0.01" name="aiomatic_listicle_list[top_p][]" value="" placeholder="1" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="-2" step="0.01" max="2" name="aiomatic_listicle_list[presence_penalty][]" value="" placeholder="0" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="0" max="2" step="0.01" name="aiomatic_listicle_list[frequency_penalty][]" value="" placeholder="0" class="cr_width_full">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                             <input type="checkbox" id="royalty_free" name="aiomatic_listicle_list[royalty_free][]" checked>
                                             </td>
                                          </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <select autocomplete="off" id="search_query_repetition" name="aiomatic_listicle_list[search_query_repetition][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" id="enable_ai_images" onchange="hideImage('');" name="aiomatic_listicle_list[enable_ai_images][]" class="cr_width_full">
                                             ...
                                             <tr class="hideDalle cr_none">
                                                ...
                                                <td>
                                                <select autocomplete="off" id="image_model" name="aiomatic_listicle_list[image_model][]" class="cr_width_full">
                                             ...
                                             <tr class="hideImg cr_none">
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="model" name="aiomatic_listicle_list[image_size][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <textarea rows="1" class="cr_width_60p" name="aiomatic_listicle_list[image_url][]" placeholder="Please insert the link to a valid image (spintax supported)"></textarea>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[post_prepend][]" placeholder="HTML content to prepend to the AI generated content" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[post_append][]" placeholder="HTML content to append to the AI generated content" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_listicle_list[custom_shortcodes][]" placeholder="shortcode_name => AI_MODEL @@ AI_PROMPT" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="strip_title" name="aiomatic_listicle_list[strip_title][]">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="skip_spin" name="aiomatic_listicle_list[skip_spin][]">               
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="skip_translate" name="aiomatic_listicle_list[skip_translate][]">               
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="title_once" name="aiomatic_listicle_list[title_once][]" checked>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="overwrite_existing" name="aiomatic_listicle_list[overwrite_existing][]">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[strip_by_regex][]" placeholder="regex expression" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[replace_regex][]" placeholder="regex replacement" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="post_author" name="aiomatic_listicle_list[post_author][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="submit_status" name="aiomatic_listicle_list[submit_status][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="default_type" name="aiomatic_listicle_list[default_type][]" class="cr_width_full" onchange="go_change_cats(this, '');">
                                                <?php
                                                   $is_first = true;
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="post_format" name="aiomatic_listicle_list[post_format][]" class="cr_width_full">
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                             <input type="number" min="1" class="cr_width_full" name="aiomatic_listicle_list[parent_id][]" value="" placeholder="Post parent ID" class="cr_width_full">
                                             </td>
                                          </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="enable_comments" name="aiomatic_listicle_list[enable_comments][]" checked>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="enable_pingback" name="aiomatic_listicle_list[enable_pingback][]" checked>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="text" id="min_time" name="aiomatic_listicle_list[min_time][]" placeholder="Start time" class="cr_half"> - <input type="text" id="max_time" name="aiomatic_listicle_list[max_time][]" placeholder="End time" class="cr_half">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="1" cols="70" name="aiomatic_listicle_list[custom_fields][]" placeholder="Please insert your desired custom fields. Example: title_custom_field => %%post_title%%" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="1" cols="70" name="aiomatic_listicle_list[custom_tax][]" placeholder="Please insert your desired custom taxonomies. Example: custom_taxonomy_name => %%post_title%%" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                          <tr>
                                             <td>
                                             ...
                                             <td>
                                             <input type="text" class="cr_width_full" name="aiomatic_listicle_list[wpml_lang][]" value="" placeholder="WPML/Polylang language" class="cr_width_full">
                                             </td>
                                          </tr>
                                             <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="text" class="cr_width_full" name="aiomatic_listicle_list[days_no_run][]" value="" placeholder="Mo,Tu,We,Th,Fr,Sa,Su" class="cr_width_full">  
                                                </td>
                                             </tr>
                                          </table>
                                       </div>
                           ...
                           <td class="cr_short_td"><input type="checkbox" name="aiomatic_listicle_list[active][]" value="1" checked />
                              <input type="hidden" name="aiomatic_listicle_list[last_run][]" value="1988-01-27 00:00:00"/>
                           <input type="hidden" name="aiomatic_listicle_list[rule_unique_id][]" value="<?php echo esc_html(uniqid('', true));?>"/>
                           </td>
...
?>
<div class="wrap">
        <h3><?php echo esc_html__("Listicle Creator Tutorial Video:", 'aiomatic-automatic-ai-content-writer');?></h3>
        <div id="ai-video-container"><br/>
            <iframe class="ai-video" width="560" height="315" src="https://www.youtube.com/embed/pPCZPHYOaYs" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
<?php
   }
}
   if (isset($_POST['aiomatic_listicle_list'])) {
       add_action('admin_init', 'aiomatic_save_rules_listicle');
   }
   
   function aiomatic_save_rules_listicle($data2)
   {
       ...
       $data2 = $_POST['aiomatic_listicle_list'];
       $rules = get_option('aiomatic_listicle_list', array());
       if(!is_array($rules))
       {
          $rules = array();
       }
   ...
   function aiomatic_expand_rules_listicle()
   {
       $all_models = aiomatic_get_all_models(true);
       $all_assistants = aiomatic_get_all_assistants(true);
       ...
       if (!empty($rules)) {
            ...
            foreach ($rules as $request => $bundle[]) {
               ...
               $post_prepend           = $array_my_values[25];
               $post_append            = $array_my_values[26];
               $enable_ai_images       = $array_my_values[27];
               $ai_command_image       = $array_my_values[28];
               $image_size             = $array_my_values[29];
               $wpml_lang              = $array_my_values[30];
               $remove_default         = $array_my_values[31];
               $strip_title            = $array_my_values[32];
               $title_once             = $array_my_values[33];
               $category_model         = $array_my_values[34];
               $category_ai_command    = $array_my_values[35];
               $tag_model              = $array_my_values[36];
               $tag_ai_command         = $array_my_values[37];
               $min_time               = $array_my_values[38];
               $max_time               = $array_my_values[39];
               $skip_spin              = $array_my_values[40];
               $skip_translate         = $array_my_values[41];
               $post_topic_list        = $array_my_values[42];
               $post_sections_list     = $array_my_values[43];
               ...
               $sections_prompt        = $array_my_values[48];
               $content_prompt         = $array_my_values[49];
               $excerpt_prompt         = $array_my_values[50];
               $section_count          = $array_my_values[51];
               $paragraph_count        = $array_my_values[52];
               $topic_title_model      = $array_my_values[53];
               $topic_sections_model   = $array_my_values[54];
               $topic_content_model    = $array_my_values[55];
               $topic_excerpt_model    = $array_my_values[56];
               $single_content_call    = $array_my_values[57];
               $intro_prompt           = $array_my_values[58];
               $topic_intro_model      = $array_my_values[59];
               $outro_prompt           = $array_my_values[60];
               $topic_outro_model      = $array_my_values[61];
               $topic_images           = $array_my_values[62];
               $sections_role          = $array_my_values[63];
               $topic_videos           = $array_my_values[64];
               $rule_description       = $array_my_values[65];
               $custom_shortcodes      = $array_my_values[66];
               $strip_by_regex         = $array_my_values[67];
               $replace_regex          = $array_my_values[68];
               $strip_by_regex_prompts = $array_my_values[69];
               $replace_regex_prompts  = $array_my_values[70];
               $run_regex_on           = $array_my_values[71];
               $max_links              = $array_my_values[72];
               $link_post_types        = $array_my_values[73];
               $enable_toc             = $array_my_values[74];
               $title_toc              = $array_my_values[75];
               $qa_prompt              = $array_my_values[76];
               $topic_qa_model         = $array_my_values[77];
               $enable_qa              = $array_my_values[78];
               $title_qa               = $array_my_values[79];
               $title_outro            = $array_my_values[80];
               $link_type              = $array_my_values[81];
               $link_list              = $array_my_values[82];
               $skip_inexist           = $array_my_values[83];
               $global_prepend         = $array_my_values[84];
               $global_append          = $array_my_values[85];
               $search_query_repetition= $array_my_values[86];
               $img_all_headings       = $array_my_values[87];
               $heading_img_location   = $array_my_values[88];
               $days_no_run            = $array_my_values[89];
               $overwrite_existing     = $array_my_values[90];
               $link_nofollow          = $array_my_values[91];
               $title_generator_method = $array_my_values[92];
               $parent_id              = $array_my_values[93];
               $rule_unique_id         = $array_my_values[94];
               $image_model            = $array_my_values[95];
               $assistant_id           = $array_my_values[96];
               ...
               $output .= '<tr>
                           <td class="cr_short_td"><input type="text" name="aiomatic_listicle_list[rule_description][]" id="rule_description' . esc_html($cont) . '" class="cr_center" placeholder="Rule ID" value="' . esc_html($rule_description) . '" class="cr_width_full"/></td>
                           <td class="cr_loi"><textarea rows="1" name="aiomatic_listicle_list[post_title][]" placeholder="Please insert your post titles/TXT file URL/RSS feed URLs/%%ai_generated_title%% shortcode" class="cr_width_full">' . htmlspecialchars($post_title) . '</textarea></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="1" placeholder="# h" name="aiomatic_listicle_list[schedule][]" max="8765812" value="' . esc_attr($schedule) . '" class="cr_width_60" required></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="0" placeholder="#" name="aiomatic_listicle_list[max][]" value="' . esc_attr($max) . '"  class="cr_width_60" required></td>
                       <td class="cr_width_70 cr_center">
     ...
     <div class="codemodalfzr-content">
       ...
       <div class="table-responsive">
         ...
         <td><select id="assistant_id' . esc_html($cont) . '" name="aiomatic_listicle_list[assistant_id][]" class="cr_width_full" onchange="assistantSelected(\'' . esc_html($cont) . '\');">';
if($all_assistants === false)
{
...
$output .= '</select>  
         ...
         <tr class="hidetopic' . esc_html($cont) . '"><td colspan="2"><h3>' . esc_html__('Listicle Article Options', 'aiomatic-automatic-ai-content-writer') . ':</h3></td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[post_topic_list][]" placeholder="Example: \'funny dog facts\', \'best houseplants\', \'proven ways to save money\'" class="cr_width_full">' . esc_textarea($post_topic_list) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" class="cr_width_full" id="title_generator_method' . esc_html($cont) . '" name="aiomatic_listicle_list[title_generator_method][]">
                       <option value="ai"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[post_sections_list][]" placeholder="Post sections list (one per line)" class="cr_width_full">' . esc_textarea($post_sections_list) . '</textarea>
         ...
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Enter the number of listicle entries to create in the article. These will also be set as article headings. You can also set value ranges, example: 5-7. In this case, a random number will be selected in this range. Please use only numeric values in this field. This field will set the value of the %%sections_count%% shortcode.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("Number Listicle Entries To Generate", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     
                     </td><td>
                     <input type="text" id="section_count' . esc_html($cont) . '" name="aiomatic_listicle_list[section_count][]" placeholder="3-4" class="cr_width_full" value="' . esc_attr($section_count) . '">
         </div>
         </td></tr>
         <tr class="hidetopic' . esc_html($cont) . '"><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Select what you want to do with listicle entries in articles.", 'aiomatic-automatic-ai-content-writer') . '
                           </div>
                       </div>
                       <b>' . esc_html__("Add Listicle Entries To Content As", 'aiomatic-automatic-ai-content-writer') . ':</b>
                       
                       </td><td>
                       <select autocomplete="off" class="cr_width_full" id="sections_role' . esc_html($cont) . '" name="aiomatic_listicle_list[sections_role][]">
                       <option value="h2"';
               if ($sections_role == 'h2') {
                   $output .= ' selected';
               }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <b>' . esc_html__("Number Of Paragraphs Per Listicle Entry", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     
                     </td><td>
                     <input type="text" id="paragraph_count' . esc_html($cont) . '" name="aiomatic_listicle_list[paragraph_count][]" placeholder="2-3" class="cr_width_full" value="' . esc_attr($paragraph_count) . '">
         </div>
         </td></tr>
         <tr class="hidetopic' . esc_html($cont) . '"><td class="cr_min_width_200">
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="text" name="aiomatic_listicle_list[topic_images][]" value="' . esc_attr($topic_images) . '" placeholder="Number of images" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="img_all_headings' . esc_html($cont) . '" name="aiomatic_listicle_list[img_all_headings][]"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" id="heading_img_location' . esc_html($cont) . '" name="aiomatic_listicle_list[heading_img_location][]" class="cr_width_full">
                                    <option value="top"';
         ...
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Set the number of related social embeds to add to the created post content. The maximum number of embeds you can add to each article: number of sections You can select the source of the social embeds, in the plugin's 'Settings' menu -> 'Bulk Posts' tab -> 'Social Networks To Get Embeds From In AI Created Articles' settings field.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("Number of Social Network Embeds To Add To The Article", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     </td><td>
                     <input type="number" min="0" name="aiomatic_listicle_list[topic_videos][]" value="' . esc_attr($topic_videos) . '" placeholder="Number of social embeds" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="title_outro' . esc_html($cont) . '" name="aiomatic_listicle_list[title_outro][]" type="text" placeholder="Optional" class="coderevolution_gutenberg_input" value="' . esc_attr($title_outro) . '"/>           
         </div>
         </td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_toc' . esc_html($cont) . '" name="aiomatic_listicle_list[enable_toc][]"';
         if($enable_toc == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="title_toc' . esc_html($cont) . '" name="aiomatic_listicle_list[title_toc][]" type="text" placeholder="Table of Contents" class="coderevolution_gutenberg_input" value="' . esc_attr($title_toc) . '"/>           
         </div>
         </td></tr>
         <tr class="hidetopic' . esc_html($cont) . '"><td>
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_qa' . esc_html($cont) . '" name="aiomatic_listicle_list[enable_qa][]"';
         if($enable_qa == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="title_qa' . esc_html($cont) . '" name="aiomatic_listicle_list[title_qa][]" type="text" placeholder="Q&A" class="coderevolution_gutenberg_input" value="' . esc_attr($title_qa) . '"/>           
         </div>
         </td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="content_language' . esc_html($cont) . '" name="aiomatic_listicle_list[content_language][]" type="text" list="languages" placeholder="Created content language" class="coderevolution_gutenberg_input" value="' . esc_attr($content_language) . '"/>                         
         </div>
         </td></tr>
         <tr class="hidetopic' . esc_html($cont) . '"><td class="cr_min_width_200">
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="writing_style' . esc_html($cont) . '" name="aiomatic_listicle_list[writing_style][]" type="text" list="writing_styles" placeholder="Created content writing style" class="coderevolution_gutenberg_input" value="' . esc_attr($writing_style) . '"/>                         
         </div>
         </td></tr>
         <tr class="hidetopic' . esc_html($cont) . '"><td class="cr_min_width_200">
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="writing_tone' . esc_html($cont) . '" name="aiomatic_listicle_list[writing_tone][]" type="text" list="writing_tones" placeholder="Created content writing tone" class="coderevolution_gutenberg_input" value="' . esc_attr($writing_tone) . '"/>                         
         </div>
         </td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[title_prompt][]" placeholder="Enter your title prompts, one per line" class="cr_width_full">' . esc_textarea($title_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[topic_title_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[intro_prompt][]" placeholder="Enter your intro prompts, one per line" class="cr_width_full">' . esc_textarea($intro_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[topic_intro_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Prompt to be used for the Listicle Entries. You can use the following shortcodes: %%title%%, %%topic%%, %%language%%, %%writing_style%%, %%writing_tone%%, %%sections_count%%, %%random_sentence%%, %%random_sentence2%%, %%post_original_title%%, %%blog_title%% - Update: %%related_questions_KEYWORD%% is also supported, to get a list of PAA questions for the KEYWORD you want to use. Update: nested shortcodes also supported (shortcodes generated by rules from other plugins). You will also be able to use the custom shortcodes defined in the 'Custom Shortcode Creator' feature from the rule settings - this will allow you to create partially or fully AI generated prompts which will be used for the content generators.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("Listicle Entries Prompt", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     
                     </td><td>
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[sections_prompt][]" placeholder="Enter your sections prompts, one per line" class="cr_width_full">' . esc_textarea($sections_prompt) . '</textarea>
         ...
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Select the AI Model to be used for the Listicle Entries generator.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("AI Model For Listicle Entries Generator", 'aiomatic-automatic-ai-content-writer') . ':</b>   
                     </td><td class="cr_min_width_200">
                     <select autocomplete="off" name="aiomatic_listicle_list[topic_sections_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <b>' . esc_html__("Listicle Entries Content Prompt", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     
                     </td><td>
                     <textarea rows="3" cols="70" name="aiomatic_listicle_list[content_prompt][]" placeholder="Enter your content prompt" class="cr_width_full">' . esc_textarea($content_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[topic_content_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="single_content_call' . esc_html($cont) . '" name="aiomatic_listicle_list[single_content_call][]"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[qa_prompt][]" placeholder="Enter your Q&A prompts, one per line" class="cr_width_full">' . esc_textarea($qa_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[topic_qa_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[outro_prompt][]" placeholder="Enter your outro prompts, one per line" class="cr_width_full">' . esc_textarea($outro_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[topic_outro_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[excerpt_prompt][]" placeholder="Enter your excerpt prompts, one per line" class="cr_width_full">' . esc_textarea($excerpt_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[topic_excerpt_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[strip_by_regex_prompts][]" placeholder="regex" class="cr_width_full">' . esc_textarea($strip_by_regex_prompts) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[replace_regex_prompts][]" placeholder="regex replacement" class="cr_width_full">' . esc_textarea($replace_regex_prompts) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="run_regex_on' . esc_html($cont) . '" name="aiomatic_listicle_list[run_regex_on][]" type="text" list="run_regex_on_list' . esc_html($cont) . '" class="coderevolution_gutenberg_input" value="' . esc_attr($run_regex_on) . '"/>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[global_prepend][]" placeholder="Global prompt prepend text" class="cr_width_full">' . esc_textarea($global_prepend) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[global_append][]" placeholder="Global prompt append text" class="cr_width_full">' . esc_textarea($global_append) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" class="cr_width_full" id="link_type' . esc_html($cont) . '" onchange="hideLinks(' . esc_html($cont) . ');" name="aiomatic_listicle_list[link_type][]">
         ...
         <tr><td class="cr_min_width_200">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" name="aiomatic_listicle_list[max_links][]" placeholder="Add the number of links to enable this feature" class="cr_width_full" value="' . esc_attr($max_links) . '">
           </div>
           </td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="1" cols="70" name="aiomatic_listicle_list[link_list][]" placeholder="URL list (one per line)" class="cr_width_full">' . esc_textarea($link_list) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" name="aiomatic_listicle_list[link_nofollow][]"';
         if($link_nofollow == '1')
         {
             $output .= ' checked';
         }
         ...
         <tr><td class="cr_min_width_200">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" name="aiomatic_listicle_list[link_post_types][]" placeholder="post" class="cr_width_full" value="' . esc_attr($link_post_types) . '">
           </div>
           </td></tr>
         ...
         <tr><td>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" class="cr_width_full" id="auto_categories' . esc_html($cont) . '" name="aiomatic_listicle_list[auto_categories][]">
                       <option value="disabled"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[category_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[category_ai_command][]" placeholder="Write a comma separated list of categories, for the post title: %%post_title%%" class="cr_width_full">' . esc_textarea($category_ai_command) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select multiple class="cr_width_full" id="default_category' . esc_html($cont) . '" name="aiomatic_listicle_list[default_category' . esc_html($cont) . '][]" onmouseover="this.size=this.length;" onmouseout="this.size=4;">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="remove_default' . esc_html($cont) . '" name="aiomatic_listicle_list[remove_default][]"';
         if($remove_default == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="skip_inexist' . esc_html($cont) . '" name="aiomatic_listicle_list[skip_inexist][]"';
         if($skip_inexist == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" class="cr_width_full" id="auto_tags' . esc_html($cont) . '" name="aiomatic_listicle_list[auto_tags][]">
                     <option value="disabled"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[tag_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
if(empty($tag_model))
{
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[tag_ai_command][]" placeholder="Write a comma separated list of tags, for the post title: %%post_title%%" class="cr_width_full">' . esc_textarea($tag_ai_command) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input class="cr_width_full" type="text" name="aiomatic_listicle_list[default_tags][]" value="' . esc_attr($default_tags) . '" placeholder="Please insert your additional post tags here" >
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_listicle_list[max_tokens][]" value="' . esc_attr($max_tokens) . '" placeholder="32768" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_listicle_list[max_seed_tokens][]" value="' . esc_attr($max_seed_tokens) . '" placeholder="1000" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="0" step="0.01" max="2" name="aiomatic_listicle_list[temperature][]" value="' . esc_attr($temperature) . '" placeholder="1" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="0" step="0.01" max="1" name="aiomatic_listicle_list[top_p][]" value="' . esc_attr($top_p) . '" placeholder="1" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="-2" max="2" step="0.01" name="aiomatic_listicle_list[presence_penalty][]" value="' . esc_attr($presence_penalty) . '" placeholder="0" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="-2" step="0.01" max="2" name="aiomatic_listicle_list[frequency_penalty][]" value="' . esc_attr($frequency_penalty) . '" placeholder="0" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="royalty_free' . esc_html($cont) . '" name="aiomatic_listicle_list[royalty_free][]"';
             if ($royalty_free == '1') {
                 $output .= ' checked';
             }
             $output .= '>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[search_query_repetition][]" class="cr_width_full">
                                   <option value="0"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select id="enable_ai_images' . esc_html($cont) . '" onchange="hideImage(' . esc_html($cont) . ');" autocomplete="off" name="aiomatic_listicle_list[enable_ai_images][]" class="cr_width_full">
                                   <option value="0"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_listicle_list[ai_command_image][]" placeholder="Please insert a command for the AI image generator" class="cr_width_full">' . esc_textarea($ai_command_image) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[image_model][]" class="cr_width_full">
                                   <option value="dalle2"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_listicle_list[image_size][]" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[image_url][]" placeholder="Please insert the link to a valid image (spintax supported)">' . esc_textarea($image_url) . '</textarea>
         ...
         <tr><td colspan="2"><h3>' . esc_html__('Posting Options', 'aiomatic-automatic-ai-content-writer') . ':</h3></td></tr>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="2" cols="70" name="aiomatic_listicle_list[post_prepend][]" placeholder="HTML content to prepend to the AI generated content" class="cr_width_full">' . esc_textarea($post_prepend) . '</textarea>
           </div>
           </td></tr><tr><td class="cr_min_width_200">
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="2" cols="70" name="aiomatic_listicle_list[post_append][]" placeholder="HTML content to append to the AI generated content" class="cr_width_full">' . esc_textarea($post_append) . '</textarea>
           </div>
           </td></tr><tr><td class="cr_min_width_200">
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="2" cols="70" name="aiomatic_listicle_list[custom_shortcodes][]" placeholder="shortcode_name => AI_MODEL @@ AI_PROMPT" class="cr_width_full">' . esc_textarea($custom_shortcodes) . '</textarea>
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="strip_title' . esc_html($cont) . '" name="aiomatic_listicle_list[strip_title][]"';
           if($strip_title == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="skip_spin' . esc_html($cont) . '" name="aiomatic_listicle_list[skip_spin][]"';
           if($skip_spin == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="skip_translate' . esc_html($cont) . '" name="aiomatic_listicle_list[skip_translate][]"';
           if($skip_translate == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="title_once' . esc_html($cont) . '" name="aiomatic_listicle_list[title_once][]"';
           if($title_once == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="overwrite_existing' . esc_html($cont) . '" name="aiomatic_listicle_list[overwrite_existing][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[strip_by_regex][]" placeholder="regex" class="cr_width_full">' . esc_textarea($strip_by_regex) . '</textarea>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" class="cr_width_full" name="aiomatic_listicle_list[replace_regex][]" placeholder="regex replacement" class="cr_width_full">' . esc_textarea($replace_regex) . '</textarea>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="post_author' . esc_html($cont) . '" name="aiomatic_listicle_list[post_author][]" class="cr_width_full">';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="submit_status' . esc_html($cont) . '" name="aiomatic_listicle_list[submit_status][]" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="default_type' . esc_html($cont) . '" name="aiomatic_listicle_list[default_type][]" class="cr_width_full" onchange="go_change_cats(this, \'' . esc_html($cont) . '\');">';
               foreach ( get_post_types( '', 'names' ) as $post_type ) {
                  if(strstr($post_type, 'aiomatic_'))
                  {
                     continue;
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="post_format' . esc_html($cont) . '" name="aiomatic_listicle_list[post_format][]" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" class="cr_width_full" name="aiomatic_listicle_list[parent_id][]" value="' . esc_attr($parent_id) . '" placeholder="Post parent ID" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_comments' . esc_html($cont) . '" name="aiomatic_listicle_list[enable_comments][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_pingback' . esc_html($cont) . '" name="aiomatic_listicle_list[enable_pingback][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" id="min_time' . esc_html($cont) . '" name="aiomatic_listicle_list[min_time][]" value="' . esc_attr($min_time) . '" placeholder="Start time" class="cr_half"> - <input type="text" id="max_time' . esc_html($cont) . '" name="aiomatic_listicle_list[max_time][]" value="' . esc_attr($max_time) . '" placeholder="End time" class="cr_half">   
           </div>
           </td></tr><tr><td class="cr_min_width_200">
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" cols="70" name="aiomatic_listicle_list[custom_fields][]" placeholder="Please insert your desired custom fields. Example: title_custom_field => %%post_title%%" class="cr_width_full">' . esc_textarea($custom_fields) . '</textarea>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Post Custom Taxonomies", 'aiomatic-automatic-ai-content-writer') . ':</b>&nbsp;<b><a href="https://coderevolution.ro/knowledge-base/faq/post-template-reference-advanced-usage/" target="_blank">&#9432;</a></b>
                         ...
                         <textarea rows="1" cols="70" name="aiomatic_listicle_list[custom_tax][]" placeholder="Please insert your desired custom taxonomies. Example: custom_taxonomy_name => %%post_title%%" class="cr_width_full">' . esc_textarea($custom_tax) . '</textarea>  
           </div>
           </td></tr><tr><td>
           <div>
          <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                      ...
                      <input type="text" class="cr_width_full" name="aiomatic_listicle_list[wpml_lang][]" value="' . esc_attr($wpml_lang) . '" placeholder="WPML/Polylang language" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="text" class="cr_width_full" name="aiomatic_listicle_list[days_no_run][]" value="' . esc_attr($days_no_run) . '" placeholder="Mo,Tu,We,Th,Fr,Sa,Su" class="cr_width_full">
         </div>
         </td></tr>
         </table></div> 
       </div>
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
                           ...
                           <td class="cr_short_td"><input type="checkbox" name="aiomatic_listicle_list[active][]" class="activateDeactivateClass" value="1"';
               if (isset($active) && $active === '1') {
                   $output .= ' checked';
               }
               $output .= '/>
                           <input type="hidden" name="aiomatic_listicle_list[last_run][]" value="' . esc_attr($last_run) . '"/>
                           <input type="hidden" name="aiomatic_listicle_list[rule_unique_id][]" value="' . esc_attr($rule_unique_id) . '"/></td>
               ...
               if ($generated_posts != 0) {
                   $output .= '<a href="' . get_admin_url() . 'edit.php?coderevolution_post_source=Aiomatic_6_' . esc_html($cont) . '&post_type=' . esc_html($def_type) . '" target="_blank">' . esc_html__('View Generated Posts', 'aiomatic-automatic-ai-content-writer') . '</a><br/>';
               }
               ...
               if (!empty($running)) {
                  if (!in_array(array($cont => 6), $running)) {
                        $f = fopen(get_temp_dir() . 'aiomatic_6_' . $cont, 'w');
                        if($f !== false)
                        {
                           flock($f, LOCK_UN);
                           fclose($f);
                           ...
                           $wp_filesystem->delete(get_temp_dir() . 'aiomatic_6_' . $cont);
                        }
                        $output .= ' cr_hidden';
                   }
                   else
                   {
                       ...
                       if($f !== false)
                       {
                           ...
                           else
                           {
                               $output .= ' cr_hidden';
                               flock($f, LOCK_UN);
                               if (($xxkey = array_search(array($cont => 6), $running)) !== false) {
                                   unset($running[$xxkey]);
               ...
               $output .= '" title="status">
                           ...
                           <select autocomplete="off" class="codemainfzr" id="actions' . esc_html($cont) . '" class="actions" name="actions" onchange="actionsChangedManual(' . esc_html($cont) . ', this.value, 6, \'' . esc_html($rule_unique_id) . '\');" onfocus="this.selectedIndex = 0;">
