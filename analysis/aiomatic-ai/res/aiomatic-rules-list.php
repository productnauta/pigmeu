                                             ...
                                             <tr class="hidetopic">
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                               echo esc_html__("Set the number of related social embeds to add to the created post content. The maximum number of embeds you can add to each article: number of sections You can select the source of the social embeds, in the plugin's 'Settings' menu -> 'Bulk Posts' tab -> 'Social Networks To Get Embeds From In AI Created Articles' settings field.", 'aiomatic-automatic-ai-content-writer');
                                                               ?>
                                                         </div>
                                                      </div>
                                                ...
                                                <td>
                                                <input type="number" min="0" name="aiomatic_rules_list[topic_videos][]" value="" placeholder="Number of social embeds" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr class="hidetopic">
                                                <td>
...
?>
                                          ...
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_rules_list[max_tokens][]" value="" placeholder="32768" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_rules_list[max_seed_tokens][]" value="" placeholder="1000" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr class="hidetitle">
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_rules_list[max_continue_tokens][]" value="" placeholder="500" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                          ...
                                          <tr><td colspan="2">
                                                  <h3><?php echo esc_html__("Featured Image Generator Options", 'aiomatic-automatic-ai-content-writer');?>:</h3>
                                             </td></tr>
                                          <tr>
                                             <td>
                                                <div>
                                             ...
                                             <tr>
                                                <td class="cr_min_width_200">
                                                      ...
                                                      <b><?php echo esc_html__("Article Featured Image Source:", 'aiomatic-automatic-ai-content-writer');?></b>
                                                </td>
                                                <td>
                                             ...
                                             <tr class="hideImg cr_none">
                                                <td class="cr_min_width_200">
                                                      ...
                                                      <b><?php echo esc_html__("Prompt For The AI Featured Image Generator:", 'aiomatic-automatic-ai-content-writer');?></b>&nbsp;<b><a href="https://coderevolution.ro/knowledge-base/faq/how-to-create-a-good-seed-prompt-command-for-aiomatic-image-generating-for-openai-dall-e-api/" target="_blank">&#9432;</a></b>
                                                </td>
                                                <td>
                                             ...
                                             <tr class="hideImg cr_none">
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="image_size" name="aiomatic_rules_list[image_size][]" class="cr_width_full">
                                          ...
                                          <tr><td colspan="2">
                                                  <h3><?php echo esc_html__("Article Image Generator Options", 'aiomatic-automatic-ai-content-writer');?>:</h3>
                                             </td></tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" id="enable_ai_images_article" onchange="hideImageArticle('');" name="aiomatic_rules_list[enable_ai_images_article][]" class="cr_width_full">
                                                   <option value="0" selected><?php echo esc_html__("Royalty Free", 'aiomatic-automatic-ai-content-writer');?></option>
                                                   <option value="1"><?php echo esc_html__("OpenAI/AiomaticAPI", 'aiomatic-automatic-ai-content-writer');?></option>
                                                   <?php
                                                   if (isset($aiomatic_Main_Settings['stability_app_id']) && trim($aiomatic_Main_Settings['stability_app_id']) != '')
                                             ...
                                             <tr class="hideImgArticle cr_none">
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_rules_list[ai_command_image_article][]" placeholder="Please insert a command for the AI image generator" class="cr_width_full">Generate a high-resolution, visually compelling image that creatively interprets the theme encapsulated by this post title: "%%post_title%%". The image should be versatile enough to fit various niches, from technology and lifestyle to nature and science. It should feature a central, eye-catching element that abstractly represents the topic, surrounded by relevant, subtler motifs that provide context and depth. The composition should be balanced and aesthetically pleasing, with a harmonious color palette that complements the mood of the title. The artwork should be suitable for use as a captivating header image for a blog post.</textarea>
                                                </td>
                                             </tr>
                                             <tr class="hideDalleArticle cr_none">
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                         <div class="bws_hidden_help_text cr_min_260px">
                                                            <?php
                                                ...
                                                <td>
                                                <select autocomplete="off" id="image_model_article" name="aiomatic_rules_list[image_model_article][]" class="cr_width_full">
                                                   <option value="dalle2"selected><?php echo esc_html__("Dall-E 2", 'aiomatic-automatic-ai-content-writer');?></option>
                                                   <option value="dalle3"><?php echo esc_html__("Dall-E 3", 'aiomatic-automatic-ai-content-writer');?></option>
                                                   <option value="dalle3hd"><?php echo esc_html__("Dall-E 3 HD", 'aiomatic-automatic-ai-content-writer');?></option>
                                                   <option value="gpt-image-1"><?php echo esc_html__("gpt-image-1", 'aiomatic-automatic-ai-content-writer');?></option>
                                             ...
                                             <tr class="hideImgArticle cr_none">
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="image_size_article" name="aiomatic_rules_list[image_size_article][]" class="cr_width_full">
                                                   <option value="256x256"><?php echo esc_html__("256x256 (only for Dall-E 2)", 'aiomatic-automatic-ai-content-writer');?></option>
                                                   <option value="512x512"><?php echo esc_html__("512x512 (only for Dall-E 2 & Stable Diffusion)", 'aiomatic-automatic-ai-content-writer');?></option>
                                                   <option value="1024x1024" selected><?php echo esc_html__("1024x1024", 'aiomatic-automatic-ai-content-writer');?></option>
                                                   <option value="1792x1024"><?php echo esc_html__("1792x1024 (only for Dall-E 3)", 'aiomatic-automatic-ai-content-writer');?></option>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="default_type" name="aiomatic_rules_list[default_type][]" class="cr_width_full" onchange="go_change_cats(this, '');">
                                                <?php
                                                   $is_first = true;
                           ...
                           <input type="hidden" name="aiomatic_rules_list[rule_unique_id][]" value="<?php echo esc_html(uniqid('', true));?>"/>
                           </td>
       ...
       if (isset($data2['post_title'][0])) {
           for ($i = 0; $i < sizeof($data2['post_title']); ++$i) 
           {
               ...
               if (isset($data2['schedule'][$i]) && $data2['schedule'][$i] != '' && $data2['post_title'][$i] != '') {
                   ...
                   $bundle[]     = trim($data2['enable_ai_images_article'][$i]);
                   $bundle[]     = trim($data2['ai_command_image_article'][$i]);
                   $bundle[]     = trim($data2['image_model_article'][$i]);
                   $bundle[]     = trim($data2['image_size_article'][$i]);
   ...
   function aiomatic_expand_rules_manual($aiomatic_Main_Settings)
   {
       ...
       if (!empty($rules)) {
            ...
            foreach ($rules as $request => $bundle[]) {
               ...
               $enable_ai_images_article = $array_my_values[112];
               $ai_command_image_article = $array_my_values[113];
               $image_model_article    = $array_my_values[114];
               $image_size_article     = $array_my_values[115];
...
$output .= '</select>  
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" class="cr_width_full" id="title_generator_method' . esc_html($cont) . '" name="aiomatic_rules_list[title_generator_method][]">
                       <option value="ai"';
         ...
         <tr class="hidetopic' . esc_html($cont) . '"><td>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" class="cr_width_full" id="sections_role' . esc_html($cont) . '" name="aiomatic_rules_list[sections_role][]">
                       <option value="h2"';
               if ($sections_role == 'h2') {
                   $output .= ' selected';
               }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="img_all_headings' . esc_html($cont) . '" name="aiomatic_rules_list[img_all_headings][]"';
         ...
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Set the number of social embeds to add to the created post content. The maximum number of embeds you can add to each article: number of sections You can select the source of the social embeds, in the plugin's 'Settings' menu -> 'Bulk Posts' tab -> 'Social Networks To Get Embeds From In AI Created Articles' settings field.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("Number of Social Network Embeds To Add To The Article", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     </td><td>
                     <input type="number" min="0" name="aiomatic_rules_list[topic_videos][]" value="' . esc_attr($topic_videos) . '" placeholder="Number of social embeds" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_toc' . esc_html($cont) . '" name="aiomatic_rules_list[enable_toc][]"';
         if($enable_toc == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_qa' . esc_html($cont) . '" name="aiomatic_rules_list[enable_qa][]"';
         if($enable_qa == '1')
         {
             $output .= ' checked';
         }
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" id="model' . esc_html($cont) . '" name="aiomatic_rules_list[model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
if(empty($model))
{
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" id="title_source' . esc_html($cont) . '" name="aiomatic_rules_list[title_source][]" class="cr_width_full">
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="videos' . esc_html($cont) . '" name="aiomatic_rules_list[videos][]"';
               if ($videos == '1') {
                   $output .= ' checked';
               }
               $output .= '>
         ...
         <tr><td>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" class="cr_width_full" id="auto_categories' . esc_html($cont) . '" name="aiomatic_rules_list[auto_categories][]">
                       <option value="disabled"';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select multiple class="cr_width_full" id="default_category' . esc_html($cont) . '" name="aiomatic_rules_list[default_category' . esc_html($cont) . '][]" onmouseover="this.size=this.length;" onmouseout="this.size=4;">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="remove_default' . esc_html($cont) . '" name="aiomatic_rules_list[remove_default][]"';
         if($remove_default == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="skip_inexist' . esc_html($cont) . '" name="aiomatic_rules_list[skip_inexist][]"';
         if($skip_inexist == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" class="cr_width_full" id="auto_tags' . esc_html($cont) . '" name="aiomatic_rules_list[auto_tags][]">
                     <option value="disabled"';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_rules_list[max_tokens][]" value="' . esc_attr($max_tokens) . '" placeholder="32768" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_rules_list[max_seed_tokens][]" value="' . esc_attr($max_seed_tokens) . '" placeholder="1000" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_rules_list[max_continue_tokens][]" value="' . esc_attr($max_continue_tokens) . '" placeholder="500" class="cr_width_full">
         ...
         <tr><td colspan="2"><h3>' . esc_html__('Featured Image Generator Options', 'aiomatic-automatic-ai-content-writer') . ':</h3></td></tr>
         <tr><td>
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="royalty_free' . esc_html($cont) . '" name="aiomatic_rules_list[royalty_free][]"';
             if ($royalty_free == '1') {
                 $output .= ' checked';
             }
             $output .= '>
         ...
         <tr><td colspan="2"><h3>' . esc_html__('Article Image Generator Options', 'aiomatic-automatic-ai-content-writer') . ':</h3></td></tr>
         <tr><td class="cr_min_width_200">
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select id="enable_ai_images_article' . esc_html($cont) . '" onchange="hideImageArticle(' . esc_html($cont) . ');" autocomplete="off" name="aiomatic_rules_list[enable_ai_images_article][]" class="cr_width_full">
                                   <option value="0"';
             if ($enable_ai_images_article == '0') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("Royalty Free", 'aiomatic-automatic-ai-content-writer') . '</option>
                                   <option value="1"';
             if ($enable_ai_images_article == '1') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("OpenAI/AiomaticAPI", 'aiomatic-automatic-ai-content-writer') . '</option>
                                   <option value="2"';
             if ($enable_ai_images_article == '2') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("Stability.AI", 'aiomatic-automatic-ai-content-writer') . '</option>
             <option value="4"';
            if ($enable_ai_images_article == '4') {
            $output .= ' selected';
            }
            $output .= '>' . esc_html__("Midjourney", 'aiomatic-automatic-ai-content-writer') . '</option>
             <option value="5"';
            if ($enable_ai_images_article == '5') {
            $output .= ' selected';
            }
            $output .= '>' . esc_html__("Replicate", 'aiomatic-automatic-ai-content-writer') . '</option>
             <option value="6"';
            if ($enable_ai_images_article == '7') {
            $output .= ' selected';
            }
            $output .= '>' . esc_html__("Google", 'aiomatic-automatic-ai-content-writer') . '</option>
             <option value="6"';
            if ($enable_ai_images_article == '6') {
            $output .= ' selected';
            }
            $output .= '>' . esc_html__("Ideogram", 'aiomatic-automatic-ai-content-writer') . '</option>
                     </select>
         ...
         <tr class="hideImgArticle' . esc_html($cont) . '"><td class="cr_min_width_200">
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Set list of prompt commands (one on each line) you want to send to the AI image generator. This command can be any given task or order, based on which, it will generate images.  You can use the following shortcodes: %%topic%%, %%post_title%%, %%post_content%%, %%post_content_plain_text%%, %%post_excerpt%%, %%post_cats%%, %%post_tags%%, %%featured_image%%, %%blog_title%%, %%author_name%%, %%current_date_time%%, %%post_link%%, %%random_sentence%%, %%random_sentence2%%. The length of this command should not be greater than 1000 characters (4000 characters for Dall-E 3), otherwise the plugin will strip it to 1000 characters length. - Update: %%related_questions_KEYWORD%% is also supported, to get a list of PAA questions for the KEYWORD you want to use. Update: nested shortcodes also supported (shortcodes generated by rules from other plugins). You can also add here a link to a .txt file, where you can add multiple prompts (one per line) and the plugin will select a random one at each run. If you use Royalty Free Images as a source, you can also set their keywords here, if no keywords set, they will be automatically generated. You will also be able to use the custom shortcodes defined in the 'Custom Shortcode Creator' feature from the rule settings - this will allow you to create partially or fully AI generated prompts which will be used for the content generators. The [aicontent] shortcode is able to be used also here.", 'aiomatic-automatic-ai-content-writer') . '&nbsp;' . sprintf( wp_kses( __( "Please check some tips and tricks about writing prompt commands, <a href='%s' target='_blank'>here</a>.", 'aiomatic-automatic-ai-content-writer'), array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), 'https://coderevolution.ro/knowledge-base/faq/how-to-create-a-good-seed-prompt-command-for-aiomatic-image-generating-for-openai-dall-e-api/' ) . '
                         </div>
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_rules_list[ai_command_image_article][]" placeholder="Please insert a command for the AI image generator" class="cr_width_full">' . esc_textarea($ai_command_image_article) . '</textarea>
                         
         </div>
         </td></tr>
         <tr class="hideDalleArticle' . esc_html($cont) . '"><td>
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Select the AI model you wish to use for image the image generator.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     ...
                     <select autocomplete="off" name="aiomatic_rules_list[image_model_article][]" class="cr_width_full">
                                   <option value="dalle2"';
             if ($image_model_article == 'dalle2') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("Dall-E 2", 'aiomatic-automatic-ai-content-writer') . '</option>
                                   <option value="dalle3"';
             if ($image_model_article == 'dalle3') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("Dall-E 3", 'aiomatic-automatic-ai-content-writer') . '</option>
                                   <option value="dalle3hd"';
             if ($image_model_article == 'dalle3hd') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("Dall-E 3 HD", 'aiomatic-automatic-ai-content-writer') . '</option>
                                   <option value="gpt-image-1"';
             if ($image_model_article == 'gpt-image-1') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("gpt-image-1", 'aiomatic-automatic-ai-content-writer') . '</option>
                     </select>
         ...
         <tr class="hideImgArticle' . esc_html($cont) . '"><td>
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Select the size of the generated image.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     ...
                     <select autocomplete="off" name="aiomatic_rules_list[image_size_article][]" class="cr_width_full">
                                   <option value="256x256"';
             if ($image_size_article == '256x256') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("256x256 (only for Dall-E 2)", 'aiomatic-automatic-ai-content-writer') . '</option>
                                   <option value="512x512"';
             if ($image_size_article == '512x512') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("512x512 (only for Dall-E 2 & Stable Diffusion)", 'aiomatic-automatic-ai-content-writer') . '</option>
                                   <option value="1024x1024"';
             if ($image_size_article == '1024x1024') {
                 $output .= ' selected';
             }
             $output .= '>' . esc_html__("1024x1024", 'aiomatic-automatic-ai-content-writer') . '</option>
             <option value="1792x1024"';
            if ($image_size_article == '1792x1024') {
            $output .= ' selected';
            }
            $output .= '>' . esc_html__("1792x1024 (only for Dall-E 3)", 'aiomatic-automatic-ai-content-writer') . '</option>
            <option value="1024x1792"';
            if ($image_size_article == '1024x1792') {
            $output .= ' selected';
            }
            $output .= '>' . esc_html__("1024x1792 (only for Dall-E 3)", 'aiomatic-automatic-ai-content-writer') . '</option>
             <option value="1536x1024"';
            if ($image_size_article == '1536x1024') {
            $output .= ' selected';
            }
            $output .= '>' . esc_html__("1536x1024 (only for gpt-image-1)", 'aiomatic-automatic-ai-content-writer') . '</option>
            <option value="1024x1536"';
            if ($image_size_article == '1024x1536') {
            $output .= ' selected';
            }
            $output .= '>' . esc_html__("1024x1536 (only for gpt-image-1)", 'aiomatic-automatic-ai-content-writer') . '</option>
                     </select>
         ...
         <tr><td colspan="2"><h3>' . esc_html__('Posting Options', 'aiomatic-automatic-ai-content-writer') . ':</h3></td></tr>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="strip_title' . esc_html($cont) . '" name="aiomatic_rules_list[strip_title][]"';
           if($strip_title == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="skip_spin' . esc_html($cont) . '" name="aiomatic_rules_list[skip_spin][]"';
           if($skip_spin == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="skip_translate' . esc_html($cont) . '" name="aiomatic_rules_list[skip_translate][]"';
           if($skip_translate == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="title_once' . esc_html($cont) . '" name="aiomatic_rules_list[title_once][]"';
           if($title_once == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="overwrite_existing' . esc_html($cont) . '" name="aiomatic_rules_list[overwrite_existing][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="post_author' . esc_html($cont) . '" name="aiomatic_rules_list[post_author][]" class="cr_width_full">';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="submit_status' . esc_html($cont) . '" name="aiomatic_rules_list[submit_status][]" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="default_type' . esc_html($cont) . '" name="aiomatic_rules_list[default_type][]" class="cr_width_full" onchange="go_change_cats(this, \'' . esc_html($cont) . '\');">';
               foreach ( get_post_types( '', 'names' ) as $post_type ) {
                  if(strstr($post_type, 'aiomatic_'))
                  {
                     continue;
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="post_format' . esc_html($cont) . '" name="aiomatic_rules_list[post_format][]" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_comments' . esc_html($cont) . '" name="aiomatic_rules_list[enable_comments][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_pingback' . esc_html($cont) . '" name="aiomatic_rules_list[enable_pingback][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" id="min_time' . esc_html($cont) . '" name="aiomatic_rules_list[min_time][]" value="' . esc_attr($min_time) . '" placeholder="Start time" class="cr_half"> - <input type="text" id="max_time' . esc_html($cont) . '" name="aiomatic_rules_list[max_time][]" value="' . esc_attr($max_time) . '" placeholder="End time" class="cr_half">   
           </div>
           </td></tr><tr><td class="cr_min_width_200">
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
       ...
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
               ...
               $output .= '" title="status">
                           ...
                           <select autocomplete="off" class="codemainfzr" id="actions' . esc_html($cont) . '" class="actions" name="actions" onchange="actionsChangedManual(' . esc_html($cont) . ', this.value, 0, \'' . esc_html($rule_unique_id) . '\');" onfocus="this.selectedIndex = 0;">
