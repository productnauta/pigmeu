...
function aiomatic_omniblocks()
{
    ...
    $all_dalle_sizes = ['256x256' => '256x256', '512x512' => '512x512', '1024x1024' => '1024x1024', '1024x1792' => '1024x1792 (only for Dall-E 3)', '1792x1024' => '1792x1024 (only for Dall-E 3)', '1024x1536' => '1024x1536 (only for gpt-image-1)', '1536x1024' => '1536x1024 (only for gpt-image-1)'];
    ...
    $all_ideogram_sizes = ['512x512' => '512x512', '1024x1024' => '1024x1024', '1792x1024' => '1792x1024', '1024x1792' => '1024x1792'];
        ...
        foreach ($default_cards as $card_id) 
        {
            if(!empty($card_id['type']))
            {
                ...
                else
                {
                    ...
                    echo '<li data-id-str="" class="omniblock-card"><input data-clone-index="xc' . esc_html(uniqid()) . '" class="cr_center aiomatic-bold aiomatic-indigo omniblock-title" card-type="' . esc_html($card_type_found['id']) . '" type="text" placeholder="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '"  title="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '" value="' . esc_attr($card_id['name']) . '">
                    ...
                    foreach($card_type_found['shortcodes'] as $shtc)
                    {
                        echo '<li>%%' . esc_html($shtc . $card_id['identifier']) . '%%</li>';
                    }
                    echo '</ul>';
                    ...
                    echo '</div></div>&nbsp;' . esc_attr($card_type_found['name']) . '</div><p class="card-desc">' . wp_kses_post($card_type_found['description']) . '</p><div class="ai-collapsible-holder"><button class="aicollapsible" title="' . esc_html__('Show/Hide Parameters', 'aiomatic-automatic-ai-content-writer') . '"><img class="controls-icon" src="' . plugin_dir_url( __FILE__ ) . '../images/controls.png' . '"></button></div><div class="aicollapsible-parameters">';
                    ...
                    foreach($card_type_found['parameters'] as $name => $card_type)
                    {
                        ...
                        if($card_type['type'] == 'text')
                        {
                            ...
                            echo '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                            echo '<input type="text" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_html($value) . '" data-clone-index="xc' . esc_html(uniqid()) . '" id="xai' . esc_html($randval) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                            if(count($shortcodes_arr) > 0)
                            {
                                echo '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '">';
                            }
                            foreach($shortcodes_arr as $myshort)
                            {
                                ...
                                echo  '<p class="aishortcodes" data-index="" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Shortcode created by OmniBlock ID: ', 'aiomatic-automatic-ai-content-writer') . esc_html($my_id) . '">';
                                echo  esc_html($myshort);
                                echo  '</p>';
                            }
                            if(count($shortcodes_arr) > 0)
                            {
                        ...
                        elseif($card_type['type'] == 'textarea')
                        {
                            ...
                            echo '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                            echo '<textarea class="' . esc_attr($name) . ' cr_width_full" id="xai' . esc_html($randval) . '" data-clone-index="xc' . esc_html(uniqid()) . '" placeholder="' . esc_html($card_type['placeholder']) . '">' . esc_textarea($value) . '</textarea>';
                            if(count($shortcodes_arr) > 0)
                            {
                                echo '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '">';
                            }
                        ...
                        elseif($card_type['type'] == 'model_select')
                        {
                            ...
                            echo '<select autocomplete="off" id="xa' . esc_html($assistant_helper) . '" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full">';
                        ...
                        elseif($card_type['type'] == 'assistant_select')
                        {
                            ...
                            echo '<select autocomplete="off" id="sel_xa' . esc_html($assistant_helper) . '" data-clone-index="xc' . esc_html(uniqid()) . '" onchange="assistantChanged(\'xa' . esc_html($assistant_helper) . '\');" class="' . esc_attr($name) . ' cr_width_full">';
                        ...
                        elseif($card_type['type'] == 'dalle_image_size_select')
                        {
                            ...
                            echo '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full">';
                        ...
                        elseif($card_type['type'] == 'ideogram_image_size_select')
                        {
                            $value = '';
                            if(isset($card_id['parameters'][$name]))
                            {
                            ...
                            echo '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full">';
                            foreach($all_ideogram_sizes as $sizeid => $sizex)
                            {
                                echo '<option value="' . esc_attr($sizeid) .'"';
                                if($value == $sizeid)
                                {
                        ...
                        elseif($card_type['type'] == 'scraper_type')
                        {
                            ...
                            echo '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="scraper_selector ' . esc_attr($name) . ' cr_width_full" data-id-str="" data-source-field-id="ur' . esc_html($urlrandval) . '" data-target-field-id="' . esc_html($assistant_helper) . '">';
                        ...
                        elseif($card_type['type'] == 'scraper_string')
                        {
                            ...
                            echo '<input type="text" data-clone-index="xc' . esc_html(uniqid()) . '" id="st' . esc_html($assistant_helper) . '" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_html($value) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                        }
                        elseif($card_type['type'] == 'number')
                        {
                            ...
                            echo '<input type="number" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_html($value) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                        }
                        ...
                        elseif($card_type['type'] == 'google_image_model_select')
                        {
                            $value = '';
                            if(isset($card_id['parameters'][$name]))
                            {
                            ...
                            echo '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full">';
                            foreach(AIOMATIC_GOOGLE_IMAGE_MODELS as $modelx)
                            {
                                echo '<option value="' . esc_attr($modelx) .'"';
                                if($value == $modelx)
                                {
                        ...
                        elseif($card_type['type'] == 'location_selector')
                        {
                            ...
                            if (is_plugin_active('aiomatic-extension-amazon-s3-images/aiomatic-extension-amazon-s3-images.php')) 
                            {
                                ...
                                $locations['generics3'] = 'Generic Amazon S3 Storage';
                            }
                            foreach($locations as $id => $name)
                            {
                                ...
                                echo '>' . esc_html(ucfirst($name)) . '</option>';
                            }
                            echo '</select>';
                        }
                        ...
                        elseif($card_type['type'] == 'url')
                        {
                            ...
                            echo '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                            echo '<input type="url" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' ur' . esc_attr($urlrandval) . ' cr_width_full" id="xai' . esc_html($randval) . '" value="' . esc_html($value) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                            if(count($shortcodes_arr) > 0)
                            {
                                echo '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '">';
                            }
                        ...
                        elseif($card_type['type'] == 'scraper_select')
                        {
                            ...
                            echo '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . '" id="sc' . esc_html($assistant_helper) . '" class="cr_width_full">';
                            echo '<option value="0"';
                            if($value == '0')
                            {
                                echo ' selected';
                    ...
                    echo '&nbsp;<input type="checkbox" class="critical-blocks" data-clone-index="xc' . esc_html(uniqid()) . '" id="critical-' . esc_attr($card_id['identifier']) . esc_html(uniqid()) . '"';
                    if($critical == true)
                    {
                        echo ' checked';
                    }
                    ...
                    echo '&nbsp;<input type="checkbox" class="disabled-blocks" data-clone-index="xc' . esc_html(uniqid()) . '" id="disabled-' . esc_attr($card_id['identifier']) . esc_html(uniqid()) . '"';
                    if($disabled == true)
                    {
                        echo ' checked';
                    }
...
else
{
    ...
    foreach ($default_block_types as $card_id) 
    {
        if(!empty($card_id['type']))
        {
            ...
            echo '" id="' . esc_html(sanitize_title($card_id['name'])) . '_new"><input data-clone-index="xc' . esc_html(uniqid()) . '" class="cr_center aiomatic-bold aiomatic-indigo omniblock-title" card-type="' . esc_html($card_id['id']) . '" type="text" placeholder="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '"  title="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '" value="' . esc_attr($card_id['name']) . '">
            ...
            echo '">' . esc_html__('OmniBlock Type:', 'aiomatic-automatic-ai-content-writer') . '&nbsp;' . esc_attr($card_id['name']) . '</div><p class="card-desc">' . wp_kses_post($card_id['description']) . '</p><div class="ai-collapsible-holder"><button class="aicollapsible" title="' . esc_html__('Show/Hide Parameters', 'aiomatic-automatic-ai-content-writer') . '"><img class="controls-icon" src="' . plugin_dir_url( __FILE__ ) . '../images/controls.png' . '"></button></div><div class="aicollapsible-parameters">';
            echo '<h3>' . esc_html__('OmniBlock Parameters', 'aiomatic-automatic-ai-content-writer') . '&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle"><div class="bws_hidden_help_text cr_min_260px disable_drag">' . esc_html__('Set the parameters which will be used in this OmniBlock.', 'aiomatic-automatic-ai-content-writer') . '</div></div></h3><hr/>';
            $first = false;
            foreach($card_id['parameters'] as $name => $card_type)
            {
                ...
                if($card_type['type'] == 'text')
                {
                    $randval = uniqid();
                    echo '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                    echo '<input type="text" class="' . esc_attr($name) . ' cr_width_full" data-clone-index="xc' . esc_html(uniqid()) . '" id="xai' . esc_html($randval) . '" value="' . esc_attr($card_type['default_value']) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                    echo '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '"><p class="aishortcodes" data-index="" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%keyword%%</p></div>';
                    echo '</div>';
                }
                elseif($card_type['type'] == 'textarea')
                {
                    ...
                    {
                        $additional .= '<p class="aishortcodes" data-index="" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%current_input_line_counter%%</p>';
                        $additional .= '<p class="aishortcodes" data-index="" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%current_input_line%%</p>';
                        $additional .= '<p class="aishortcodes" data-index="" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%all_input_lines%%</p>';
                    }
                    echo '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                    echo '<textarea class="' . esc_attr($name) . ' cr_width_full" data-clone-index="xc' . esc_html(uniqid()) . '" id="xai' . esc_html($randval) . '" placeholder="' . esc_html($card_type['placeholder']) . '">' . esc_textarea($card_type['default_value']) . '</textarea>';
                    echo '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '"><p class="aishortcodes" data-index="" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%keyword%%</p>' . $additional  . '</div>';
                    echo '</div>';
                }
                elseif($card_type['type'] == 'model_select')
                {
                    echo '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" id="xa' . esc_html($assistant_helper) . '" class="' . esc_attr($name) . ' cr_width_full">';
                    foreach($all_models as $modelx)
                    {
                ...
                elseif($card_type['type'] == 'assistant_select')
                {
                    echo '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" id="sel_xa' . esc_html($assistant_helper) . '" onchange="assistantChanged(\'xa' . esc_html($assistant_helper) . '\');" class="' . esc_attr($name) . ' cr_width_full">';
                    if($all_assistants === false)
                    {
                        echo '<option val="" selected disabled>' . esc_html__("Only OpenAI API is supported for Assistants API", 'aiomatic-automatic-ai-content-writer') . '</option>';
                    }
                ...
                elseif($card_type['type'] == 'scraper_string')
                {
                    echo '<input type="text" class="' . esc_attr($name) . ' cr_width_full" data-clone-index="xc' . esc_html(uniqid()) . '" id="st' . esc_html($assistant_helper) . '" value="' . esc_attr($card_type['default_value']) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                }
                elseif($card_type['type'] == 'number')
                {
                    echo '<input type="number" class="' . esc_attr($name) . ' cr_width_full" data-clone-index="xc' . esc_html(uniqid()) . '" value="' . esc_attr($card_type['default_value']) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                }
                elseif($card_type['type'] == 'checkbox')
                {
                    echo '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full">';
                ...
                elseif($card_type['type'] == 'url')
                {
                    $randval = uniqid();
                    echo '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                    echo '<input type="url" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' ur' . esc_attr($urlrandval) . ' cr_width_full" id="xai' . esc_html($randval) . '" value="' . esc_attr($card_type['default_value']) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                    echo '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '"><p class="aishortcodes" data-index="" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%keyword%%</p></div>';
                    echo '</div>';
                }
                elseif($card_type['type'] == 'scraper_select')
                {
                    echo '<select data-clone-index="xc' . esc_html(uniqid()) . '" autocomplete="off" id="sc' . esc_html($assistant_helper) . '" class="' . esc_attr($name) . ' cr_width_full">';
                    echo '<option value="0"';
                    if('0' == $card_type['default_value'])
                    {
                        echo ' selected';
            ...
            echo '<h4>' . esc_html__("Critical", 'aiomatic-automatic-ai-content-writer') . ':&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle"><div class="bws_hidden_help_text cr_min_260px disable_drag">' . esc_html__("Set if this OmniBlock is critical or not. When a Critical OmniBlock fails to generate its content correctly and it fails, it will cause the entire OmniBlock running sequence to stop. Non-critical OmniBlocks when they fail, the execution of blocks will continue, the result of the failed OmniBlock will be blank.", 'aiomatic-automatic-ai-content-writer') . '</div></div>';
            echo '&nbsp;<input type="checkbox" class="critical-blocks" data-clone-index="xc' . esc_html(uniqid()) . '" id="critical-' . esc_attr($ublockid) . esc_html(uniqid()) . '"';
            if($critical == true)
            {
                echo ' checked';
            }
            ...
            echo '<h4>' . esc_html__("Disabled", 'aiomatic-automatic-ai-content-writer') . ':&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle"><div class="bws_hidden_help_text cr_min_260px disable_drag">' . esc_html__("Set if this OmniBlock is disabled or not. The disabled OmniBlocks will be skipped from processing.", 'aiomatic-automatic-ai-content-writer') . '</div></div>';
            echo '&nbsp;<input type="checkbox" class="disabled-blocks" data-clone-index="xc' . esc_html(uniqid()) . '" id="disabled-' . esc_attr($ublockid) . esc_html(uniqid()) . '"';
            if($disabled == true)
            {
                echo ' checked';
            }
...
foreach ($default_block_types as $card_id) 
{
    ...
    echo '<option value="' . esc_html(sanitize_title($card_id['name'])) . '">' . esc_html($card_id['name']) . '</option>';
}
?>
                                                </select>
                                                </td>
...
<div id="mymodalfzr_ai" class="codemodalfzr">
    <div class="codemodalfzr-content">
        <div class="codemodalfzr-header">
            <span id="aiomatic_close_ai" class="codeclosefzr">&times;</span>
            <h2><span class="cr_color_white"><?php echo esc_html__("AI Generated OmniBlock Templates (Experimental)", 'aiomatic-automatic-ai-content-writer');?></span></h2>
        </div>
        <div class="codemodalfzr-body">
        <div class="table-responsive">
        <br/>
<hr/>
<div class="aiomatic-loader-bubble">
<h3 class="margin5"><?php echo esc_html__("Generate OmniBlock Templates Using AI", 'aiomatic-automatic-ai-content-writer');?>:
<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
    <div class="bws_hidden_help_text cr_min_260px disable_drag">
        <?php
        echo esc_html__("These settings will allow you to generate OmniBlock templates using AI.", 'aiomatic-automatic-ai-content-writer');
        ?>
    </div>
</div></h3>
<div class="aiomatic_omni_upload_form">
    <table class="form-table">
        <tbody><tr>
            <th scope="row"><?php
        echo esc_html__("OmniBlock Template Title", 'aiomatic-automatic-ai-content-writer');
        ?>&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
    <div class="bws_hidden_help_text cr_min_260px disable_drag">
        <?php
        echo esc_html__("Set the title of the OmniBlock template.", 'aiomatic-automatic-ai-content-writer');
        ?>
    </div>
</div></th>
            <td>
<?php
    $default_name = "AI Template " . date('Y-m-d H:i:s');
    echo '<input type="text" class="cr_width_full" id="aiomatic_omni_name" placeholder="' . esc_html__('Set the name of the AI generated template', 'aiomatic-automatic-ai-content-writer') . '" value="' . esc_attr($default_name) . '">';
?>
            </td>
        </tr>
        <tr>
            <th scope="row"><?php
        echo esc_html__("Prompt For The OmniBlock Template Generator", 'aiomatic-automatic-ai-content-writer');
        ?>&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
    <div class="bws_hidden_help_text cr_min_260px disable_drag">
        <?php
        echo esc_html__("Select the prompt which will be used. You can use the following shortcodes: %%example_template%%, %%all_omniblock_types%%, %%title%%", 'aiomatic-automatic-ai-content-writer');
        ?>
    </div>
</div></th>
            <td>
<?php
    $default_prompt = "Don't act as a virtual assistant, respond only with the JSON, nothing more. Note that the JSON from your response will be decoded directly in my PHP code. Generate an OmniBlock template for a WordPress site with the following title: %%title%%. Each OmniBlock should have a unique ID and parameters that are relevant to its function. Note the AI writer does not have memory, you need to pass to it all data which it needs to know about and process. The template should be structured in a way that allows for easy customization and integration with the WordPress site. Example OmniBlock Template: %%example_template%% - All OmniBlock types: %%all_omniblock_types%%";
    echo '<textarea rows="12" class="cr_width_full" id="aiomatic_omni_prompt" placeholder="' . esc_html__('AI prompt for the OmniBlock template generator', 'aiomatic-automatic-ai-content-writer') . '">' . esc_textarea($default_prompt) . '</textarea>';
?>
            </td>
        </tr>
        <tr>
            <th scope="row"><?php
        echo esc_html__("AI Model For The OmniBlock Template Generator", 'aiomatic-automatic-ai-content-writer');
        ?>&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
    <div class="bws_hidden_help_text cr_min_260px disable_drag">
        <?php
        echo esc_html__("Select the AI model to be used.", 'aiomatic-automatic-ai-content-writer');
        ?>
    </div>
</div></th>
            <td>
                <select autocomplete="off" id="aiomatic_omni_model" class="cr_width_full">
                <?php
                foreach($all_models as $modelx)
                {
                    echo '<option value="' . esc_attr($modelx) .'"';
    ...
    <div class="bws_hidden_help_text cr_min_260px disable_drag">
        <?php
        echo esc_html__("Select if you want to overwrite existing templates with the same title.", 'aiomatic-automatic-ai-content-writer');
        ?>
    </div>
</div></th>
            <td>
        ...
        <tr>
            <td colspan="2">
                <div class="aiomatic_ai_success aiomatic_none margin5 colorgr"><?php
        echo esc_html__("OmniBlock template generated successfully.", 'aiomatic-automatic-ai-content-writer');
        ?></div>
                <div class="aiomatic_ai_progress aiomatic_none"><span></span><small><?php
        echo esc_html__("Generating...", 'aiomatic-automatic-ai-content-writer');
        ?></small></div>
                <div class="aiomatic-ai-error-msg"></div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <button class="button button-primary coderevolution_block_input" id="aiomatic_omni_ai_button"><?php echo esc_html__("Generate OmniBlock Templates Using AI", 'aiomatic-automatic-ai-content-writer');?></button><br>
            </td>
        </tr>
        </tbody>
    </table>
...
<div class="aiomatic-loader-bubble">
    <div>
            ...
            <form method="post" onsubmit="return confirm('Are you sure you want to download OmniBlock Templates to file?');"><input name="aiomatic_nonce" type="hidden" value="<?php echo esc_html(wp_create_nonce('aiomatic_omni'));?>"><input name="aiomatic_download_omni_to_file" type="submit" class="button button-primary coderevolution_block_input" value="Export OmniBlock Templates To File"></form>
         </div>
</div>
<br/>
<hr/>
...
<br/><br/>
<input name="aiomatic_nonce" type="hidden" value="<?php echo esc_html(wp_create_nonce('aiomatic_omni'));?>">
...
if($aiomatic_omni_file->have_posts()){
    echo '<br><br>' . esc_html__('All OmniBlock Files', 'aiomatic-automatic-ai-content-writer') . ' (' . esc_html($aiomatic_omni_file->found_posts) . ')<br>';
}
...
<table class="wp-list-table widefat fixed striped table-view-list posts">
    ...
    if($aiomatic_omni_file->have_posts())
    {
        foreach ($aiomatic_omni_file->posts as $aiomatic_omni_f)
        {
            ?>
            <tr>
                <td><input class="aiomatic-select-omni-file" id="aiomatic-select-<?php echo esc_html($aiomatic_omni_f->ID);?>" type="checkbox" name="ids[]" value="<?php echo esc_html($aiomatic_omni_f->ID);?>"></td>
...
?></td>
                ...
                <td>
                <div class="cr_center">
                <form method="post"><input name="aiomatic_nonce" type="hidden" value="<?php echo esc_html(wp_create_nonce('aiomatic_omni'));?>"><input name="aiomatic_fid" type="hidden" value="<?php echo esc_html($aiomatic_omni_f->ID);?>"><a class="button button-small" target="_blank" href="<?php echo esc_url($aiomatic_omni_f->post_content);?>"><?php echo esc_html__("View", 'aiomatic-automatic-ai-content-writer');?></a>&nbsp;<input name="aiomatic_download_omni_file" type="submit" class="button button-small" value="Download">&nbsp;<button class="button button-small button-link-delete aiomatic_delete_omni_file" id="aiomatic_delete_omni_file_<?php echo esc_html($aiomatic_omni_f->ID);?>" delete-id="<?php echo esc_html($aiomatic_omni_f->ID);?>"><?php echo esc_html__("Delete", 'aiomatic-automatic-ai-content-writer');?></button>
                </form>
                </div>
            </td>
            </tr>
...
<br/>
        ...
        ?></button>
        <button href="#" id="aiomatic_ai_templates" class="page-title-action"><?php
        echo esc_html__("Generate OmniBlock Templates Using AI", 'aiomatic-automatic-ai-content-writer');
        ?></button>
...
if (is_array($categories)) {
    foreach ($categories as $category) {
        ...
        echo '<option value="' . esc_attr($category->slug) . '" ' . esc_html($selected) . '>' . esc_html($category->name) . '</option>';
    }
}
echo '</select>';
echo '</div>';
if($aiomatic_omni_temp->have_posts()){
    echo esc_html__('OmniBlock Templates', 'aiomatic-automatic-ai-content-writer') . ' (' . esc_html($aiomatic_omni_temp->found_posts) . ')<br>';
}
?>
<table class="wp-list-table widefat fixed striped table-view-list posts">
    <thead>
    ...
    if($aiomatic_omni_temp->have_posts())
    {
        foreach ($aiomatic_omni_temp->posts as $aiomatic_omni_template)
        {
            ?>
            <tr>
                <td><input class="aiomatic-select-omni-template" id="aiomatic-select-<?php echo esc_html($aiomatic_omni_template->ID);?>" type="checkbox" name="ids[]" value="<?php echo esc_html($aiomatic_omni_template->ID);?>"></td>
...
?></td>
                ...
                <td>
                <div class="cr_center">
                <button class="button button-small aiomatic_duplicate_omni_template" id="aiomatic_duplicate_omni_template_<?php echo esc_html($aiomatic_omni_template->ID);?>" dup-id="<?php echo esc_html($aiomatic_omni_template->ID);?>"><?php echo esc_html__("Duplicate", 'aiomatic-automatic-ai-content-writer');?></button>
                <button class="button button-small aiomatic_edit_omni_template" id="aiomatic_edit_omni_template_<?php echo esc_html($aiomatic_omni_template->ID);?>" edit-id="<?php echo esc_html($aiomatic_omni_template->ID);?>"><?php echo esc_html__("Edit", 'aiomatic-automatic-ai-content-writer');?></button>
                <button class="button button-small button-link-delete aiomatic_delete_omni_template" id="aiomatic_delete_omni_template_<?php echo esc_html($aiomatic_omni_template->ID);?>" delete-id="<?php echo esc_html($aiomatic_omni_template->ID);?>"><?php echo esc_html__("Delete", 'aiomatic-automatic-ai-content-writer');?></button>
                </div>
            </td>
            </tr>
            <?php
...
{
?>
		<a href="<?php echo esc_url(key($v['link']));?>" target="_blank">
<?php
}
?>
			<div class="aiomatic-magic-feature <?php echo esc_attr($k);?>">
				<div class="aiomatic-magic-box-title"><?php echo esc_html($v['name']);?></div>
				<div class="aiomatic-magic-box-desc"><?php echo wp_kses_post($v['description']);?></div><br/>
				<div class="aiomatic-magic-box-desc"><?php echo esc_html__('Category:', 'aiomatic-automatic-ai-content-writer') . '&nbsp;' . esc_html(trim($v['category'], ' -'));?></div>
                <?php
                if(!$v['enabled'])
                {
                ?>
...
<p class="cr_center"><div class="embedtool"><iframe src="https://www.youtube.com/embed/gCbUO6Pf6ag" frameborder="0" allowfullscreen></iframe></div></p>
<?php
}
?>
</div>
...
<div class="wrap gs_popuptype_holder seo_pops">
   <div>
      <form novalidate id="myForm" method="post" action="<?php echo esc_url((aiomatic_isSecure() ? "https" : "http") . "://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]");?>">
         <?php
            ...
            <div class="hideMain">
               ...
               <div class="table-responsive">
                  <table id="mainRules" class="aiomatic-automation responsive table cr_main_table">
                     ...
                     <tbody>
                        <?php
                           echo aiomatic_expand_rules_omni($default_block_types, $all_models, $all_models_function, $all_dalle_models, $all_stable_models, $all_assistants, $all_stable_sizes, $all_midjourney_sizes, $all_replicate_sizes, $all_ideogram_sizes, $all_stable_video_sizes, $all_dalle_sizes, $all_scraper_types, $aiomatic_Main_Settings, $all_formats, $language_names, $language_codes, $deepl_auth, $language_names_deepl, $language_codes_deepl, $bing_auth, $language_names_bing, $language_codes_bing, $temp_list, $aiomatic_tax_names);
...
else
{
    ...
    foreach ($default_block_types as $card_id) 
    {
        if(!empty($card_id['type']))
        {
            ...
            echo '" id="' . esc_html(sanitize_title($card_id['name'])) . '"><input data-clone-index="xc' . esc_html(uniqid()) . '" class="cr_center aiomatic-bold aiomatic-indigo omniblock-title" card-type="' . esc_html($card_id['id']) . '" type="text" placeholder="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '"  title="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '" value="' . esc_attr($card_id['name']) . '">
            <input type="hidden" class="omniblock-id" card-type="' . esc_html($card_id['id']) . '" value="' . esc_attr($ublockid) . '">
            <input type="hidden" class="omniblock-shortcodes" card-type="' . esc_html($card_id['id']) . '" value="' . esc_attr(implode(',', $local_shortcodes)) . '">';
            if($card_id['id'] == 'text_spinner')
            {
...
function aiomatic_expand_rules_omni($default_block_types, $all_models, $all_models_function, $all_dalle_models, $all_stable_models, $all_assistants, $all_stable_sizes, $all_midjourney_sizes, $all_replicate_sizes, $all_ideogram_sizes, $all_stable_video_sizes, $all_dalle_sizes, $all_scraper_types, $aiomatic_Main_Settings, $all_formats, $language_names, $language_codes, $deepl_auth, $language_names_deepl, $language_codes_deepl, $bing_auth, $language_names_bing, $language_codes_bing, $temp_list, $aiomatic_tax_names)
{
    ...
    {
        $warning .= '<p>' . esc_html__('Error: Failed to decode OmniBlocks data!', 'aiomatic-automatic-ai-content-writer') . '</p>';
    }
    if($warning != '')
    {
        ...
        else
        {
            ...
            foreach ($saved_cards as $card_id) 
            {
                ...
                if(!empty($card_id['type']))
                {
                    ...
                    if(aiomatic_compareIds($last_id, $largest_id) > 0)
                    {
                        $largest_id = $last_id;
                    }
                    $card_type_found = array();
                    ...
                    else
                    {
                        ...
                        $output .= '<li data-id-str="' . esc_html($cont) . '" class="omniblock-card"><input data-clone-index="xc' . esc_html(uniqid()) . '" class="cr_center aiomatic-bold aiomatic-indigo omniblock-title" card-type="' . esc_html($card_type_found['id']) . '" type="text" placeholder="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '"  title="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '" value="' . esc_attr($card_id['name']) . '">
                        ...
                        $card_type_found['description'] = str_replace('%%filter_name%%', '<br/><span class="cr_red disable_drag">aiomatic_diy_omniblock_' . trim($card_id['identifier']) . '</span>', $card_type_found['description']);
                        $output .= '</div></div>&nbsp;' . esc_attr($card_type_found['name']) . '</div><p class="card-desc">' . wp_kses_post($card_type_found['description']) . '</p><div class="ai-collapsible-holder"><button class="aicollapsible" title="' . esc_html__('Show/Hide Parameters', 'aiomatic-automatic-ai-content-writer') . '"><img class="controls-icon" src="' . plugin_dir_url( __FILE__ ) . '../images/controls.png' . '"></button></div><div class="aicollapsible-parameters">';
                        ...
                        foreach($card_type_found['parameters'] as $name => $card_type)
                        {
                            ...
                            if($card_type['type'] == 'text')
                            {
                                ...
                                $output .= '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                                $output .= '<input type="text" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_html($value) . '" id="xai' . esc_html($randval) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                                if(count($new_shortcodes_arr) > 0)
                                {
                                    $output .= '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '">';
                                }
                                foreach($new_shortcodes_arr as $myshort)
                                {
                                    ...
                                    $my_id = end($my_id);
                                    $my_id = substr($my_id, 0, -2);
                                    $output .=  '<p class="aishortcodes" data-index="' . esc_html($cont) . '" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Shortcode created by OmniBlock ID: ', 'aiomatic-automatic-ai-content-writer') . esc_html($my_id) . '">';
                                    $output .=  $myshort;
                                    $output .=  '</p>';
                                }
                                if(count($new_shortcodes_arr) > 0)
                            ...
                            elseif($card_type['type'] == 'textarea')
                            {
                                ...
                                $output .= '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                                $output .= '<textarea class="' . esc_attr($name) . ' cr_width_full" data-clone-index="xc' . esc_html(uniqid()) . '" id="xai' . esc_html($randval) . '" placeholder="' . esc_html($card_type['placeholder']) . '">' . esc_textarea($value) . '</textarea>';
                                if(count($new_shortcodes_arr) > 0)
                                {
                                    $output .= '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '">';
                                }
                            ...
                            elseif($card_type['type'] == 'model_select')
                            {
                                ...
                                $output .= '<select autocomplete="off" id="xa' . esc_html($assistant_helper) . '" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full">';
                                foreach($all_models as $modelx)
                                {
                            ...
                            elseif($card_type['type'] == 'assistant_select')
                            {
                                ...
                                $output .= '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" id="sel_xa' . esc_html($assistant_helper) . '" onchange="assistantChanged(\'xa' . esc_html($assistant_helper) . '\');" class="' . esc_attr($name) . ' cr_width_full">';
                                if($all_assistants === false)
                                {
                                ...
                                $output .= '</select>';
                                wp_add_inline_script(md5(get_bloginfo()) . '-footer-script', 'assistantChanged(\'xa' . esc_html($assistant_helper) . '\');', 'after');
                            }
                            elseif($card_type['type'] == 'dalle_image_size_select')
                            {
                                $value = '';
                                ...
                                $output .= '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full">';
                                foreach($all_dalle_sizes as $sizeid => $sizex)
                                {
                            ...
                            elseif($card_type['type'] == 'scraper_type')
                            {
                                ...
                                $output .= '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="scraper_selector ' . esc_attr($name) . ' cr_width_full" data-id-str="' . esc_html($cont) . '" data-source-field-id="ur' . esc_html($urlrandval) . '" data-target-field-id="' . esc_html($assistant_helper) . '">';
                                foreach($all_scraper_types as $index => $modelx)
                                {
                            ...
                            elseif($card_type['type'] == 'scraper_string')
                            {
                                ...
                                $output .= '<input type="text" id="st' . esc_html($assistant_helper) . '" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_html($value) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                            }
                            elseif($card_type['type'] == 'number')
                            {
                                $value = '';
                                ...
                                $output .= '<input type="number" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_html($value) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                            }
                            elseif($card_type['type'] == 'checkbox')
                            {
                                $value = '';
                            ...
                            elseif($card_type['type'] == 'location_selector')
                            {
                                ...
                                foreach($locations as $id => $name)
                                {
                                    ...
                                    $output .= '>' . esc_html(ucfirst($name)) . '</option>';
                                }
                                $output .= '</select>';
                            }
                            elseif($card_type['type'] == 'select')
                            ...
                            elseif($card_type['type'] == 'url')
                            {
                                ...
                                $output .= '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                                $output .= '<input type="url" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' ur' . esc_attr($urlrandval) . ' cr_width_full" value="' . esc_html($value) . '" id="xai' . esc_html($randval) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                                if(count($new_shortcodes_arr) > 0)
                                {
                                    $output .= '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '">';
                                }
                            ...
                            elseif($card_type['type'] == 'scraper_select')
                            {
                                ...
                                $output .= '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" id="sc' . esc_html($assistant_helper) . '" class="' . esc_attr($name) . '" class="cr_width_full">';
                                $output .= '<option value="0"';
                                if($value == '0')
                                {
                                    $output .= ' selected';
                        ...
                        $output .= '&nbsp;<input type="checkbox" class="critical-blocks" data-clone-index="xc' . esc_html(uniqid()) . '" id="critical-' . esc_attr($last_id) . esc_html(uniqid()) . '"';
                        if($critical == true)
                        {
                            $output .= ' checked';
                        }
                        ...
                        $output .= '&nbsp;<input type="checkbox" class="disabled-blocks" data-clone-index="xc' . esc_html(uniqid()) . '" id="disabled-' . esc_attr($last_id) . esc_html(uniqid()) . '"';
                        if($disabled == true)
                        {
                            $output .= ' checked';
                        }
...
<td colspan="2"><div class="aiseparator aistop"><b>' . esc_html__("OmniBlock Queue Stops Here", 'aiomatic-automatic-ai-content-writer') . '</b></div><h2>' . esc_html__('Add A New OmniBlock To The Above Queue (Drag And Drop):', 'aiomatic-automatic-ai-content-writer') . '</h2>';
    ...
    else
    {
        ...
        foreach ($default_block_types as $card_id) 
        {
            if(!empty($card_id['type']))
            {
                ...
                $output .= '" id="' . sanitize_title($card_id['name']) . esc_html($cont) . '"><input data-clone-index="xc' . esc_html(uniqid()) . '" class="cr_center aiomatic-bold aiomatic-indigo omniblock-title" card-type="' . esc_html($card_id['id']) . '" type="text" placeholder="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '"  title="' . esc_html__('OmniBlock Title', 'aiomatic-automatic-ai-content-writer') . '" value="' . esc_attr($card_id['name']) . '">
                ...
                $card_id['description'] = str_replace('%%filter_name%%', esc_html__('add this OmniBlock and save settings to get the filter name' , 'aiomatic-automatic-ai-content-writer'), $card_id['description']);
                $output .= '">' . esc_html__('OmniBlock Type:', 'aiomatic-automatic-ai-content-writer') . '&nbsp;' . esc_attr($card_id['name']) . '</div><p class="card-desc">' . wp_kses_post($card_id['description'] ). '</p><div class="ai-collapsible-holder"><button class="aicollapsible" title="' . esc_html__('Show/Hide Parameters', 'aiomatic-automatic-ai-content-writer') . '"><img class="controls-icon" src="' . plugin_dir_url( __FILE__ ) . '../images/controls.png' . '"></button></div><div class="aicollapsible-parameters">';
                $output .= '<h3>' . esc_html__('OmniBlock Parameters', 'aiomatic-automatic-ai-content-writer') . '&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle"><div class="bws_hidden_help_text cr_min_260px disable_drag">' . esc_html__('Set the parameters which will be used in this OmniBlock.', 'aiomatic-automatic-ai-content-writer') . '</div></div></h3><hr/>';
                $first = false;
                foreach($card_id['parameters'] as $name => $card_type)
                {
                    ...
                    if($card_type['type'] == 'text')
                    {
                        $randval = uniqid();
                        $output .= '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                        $output .= '<input type="text" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_attr($card_type['default_value']) . '" placeholder="' . esc_html($card_type['placeholder']) . '" id="xai' . esc_html($randval) . '">';
                        $output .= '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '"><p class="aishortcodes" data-index="' . esc_html($cont) . '" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%keyword%%</p></div>';
                        $output .= '</div>';
                    ...
                    elseif($card_type['type'] == 'textarea')
                    {
                        ...
                        $output .= '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                        $output .= '<textarea data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full" placeholder="' . esc_html($card_type['placeholder']) . '" id="xai' . esc_html($randval) . '">' . esc_textarea($card_type['default_value']) . '</textarea>';
                        $output .= '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '"><p class="aishortcodes" data-index="' . esc_html($cont) . '" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%keyword%%</p>' . $additional . '</div>';
                        $output .= '</div>';
                    }
                    elseif($card_type['type'] == 'model_select')
                    {
                        $output .= '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" id="xa' . esc_html($assistant_helper) . '" class="' . esc_attr($name) . ' cr_width_full">';
                        foreach($all_models as $modelx)
                        {
                            $output .= '<option value="' . esc_html($modelx) .'"';
                            if($modelx == $card_type['default_value'])
                    ...
                    elseif($card_type['type'] == 'scraper_string')
                    {
                        $output .= '<input type="text" data-clone-index="xc' . esc_html(uniqid()) . '" id="st' . esc_html($assistant_helper) . '" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_attr($card_type['default_value']) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                    }
                    elseif($card_type['type'] == 'number')
                    {
                        $output .= '<input type="number" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full" value="' . esc_attr($card_type['default_value']) . '" placeholder="' . esc_html($card_type['placeholder']) . '">';
                    }
                    elseif($card_type['type'] == 'checkbox')
                    {
                        $output .= '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' cr_width_full">';
                    ...
                    elseif($card_type['type'] == 'url')
                    {
                        $randval = uniqid();
                        $output .= '<div class="main-holder-short" data-id-str="xai' . esc_html($randval) . '">';
                        $output .= '<input type="url" data-clone-index="xc' . esc_html(uniqid()) . '" class="' . esc_attr($name) . ' ur' . esc_attr($urlrandval) . ' cr_width_full" value="' . esc_attr($card_type['default_value']) . '" placeholder="' . esc_html($card_type['placeholder']) . '" id="xai' . esc_html($randval) . '">';
                        $output .= '<div class="shortcode-list" data-id-str="xai' . esc_html($randval) . '"><p class="aishortcodes" data-index="' . esc_html($cont) . '" data-id-str="xai' . esc_html($randval) . '" title="' . esc_html__('Main keyword shortcode', 'aiomatic-automatic-ai-content-writer') . '">%%keyword%%</p></div>';
                        $output .= '</div>';
                    }
                    elseif($card_type['type'] == 'scraper_select')
                    {
                        $output .= '<select autocomplete="off" data-clone-index="xc' . esc_html(uniqid()) . '" id="sc' . esc_html($assistant_helper) . '" class="' . esc_attr($name) . ' cr_width_full">';
                        $output .= '<option value="0"';
                        if('0' == $card_type['default_value'])
                        {
                            $output .= ' selected';
                ...
                $output .= '<h4>' . esc_html__("Critical", 'aiomatic-automatic-ai-content-writer') . ':&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle"><div class="bws_hidden_help_text cr_min_260px disable_drag">' . esc_html__("Set if this OmniBlock is critical or not. When a Critical OmniBlock fails to generate its content correctly and it fails, it will cause the entire OmniBlock running sequence to stop. Non-critical OmniBlocks when they fail, the execution of blocks will continue, the result of the failed OmniBlock will be blank.", 'aiomatic-automatic-ai-content-writer') . '</div></div>';
                $output .= '&nbsp;<input type="checkbox" class="critical-blocks" data-clone-index="xc' . esc_html(uniqid()) . '" id="critical-' . esc_attr($save_id) . esc_html(uniqid()) . '"';
                if($critical == true)
                {
                    $output .= ' checked';
                }
                ...
                $output .= '<h4>' . esc_html__("Disabled", 'aiomatic-automatic-ai-content-writer') . ':&nbsp;<div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle"><div class="bws_hidden_help_text cr_min_260px disable_drag">' . esc_html__("Set if this OmniBlock is disabled or not. The disabled OmniBlocks will be skipped from processing.", 'aiomatic-automatic-ai-content-writer') . '</div></div>';
                $output .= '&nbsp;<input type="checkbox" class="disabled-blocks" data-clone-index="xc' . esc_html(uniqid()) . '" id="disabled-' . esc_attr($save_id) . esc_html(uniqid()) . '"';
                if($disabled == true)
                {
                    $output .= ' checked';
                }
    ...
    foreach ($default_block_types as $card_id) 
    {
        ...
        $output .= '<option value="' . esc_html(sanitize_title($card_id['name'])) . '">' . esc_html($card_id['name']) . '</option>';
    }
    $output .= '</select>
    </td>
 </tr>
   ...
   <input type="button" class="aisavetemplate button page-title-action" title="' . esc_html__('Saves the OmniBlock Queue configured above, as a new Template', 'aiomatic-automatic-ai-content-writer') . '" data-id="' . esc_html($cont) . '" value="' . esc_html__("Save New Template", 'aiomatic-automatic-ai-content-writer') . '">
    ...
    <div class="table-responsive">
        ...
        <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                    ...
                    <input type="checkbox" id="title_once' . esc_html($cont) . '" name="aiomatic_omni_list[title_once][]"';
        if($title_once == '1')
        {
            $output .= ' checked';
        }
    ...
    <div class="codemodalfzr-footer">
        ...
        <br/><br/>
            ...
            $output .= '/>
                        ...
                        <div class="bws_hidden_help_text cr_min_260px disable_drag">' . sprintf( wp_kses( __( 'Shortcode for this rule<br/>(to cross-post from this plugin in other plugins):', 'aiomatic-automatic-ai-content-writer'), array(  'br' => array( ) ) ) ) . '<br/><b>%%aiomatic_5_' . esc_html($cont) . '%% and %%aiomatic_title_5_' . esc_html($cont) . '%%</b><br/>' . esc_html__('Rule ID:', 'aiomatic-automatic-ai-content-writer') . ' ' . esc_html($cont) . '<br/>' . esc_html__('Posts Generated:', 'aiomatic-automatic-ai-content-writer') . ' ' . esc_html($generated_posts) . '<br/>';
            ...
            $output .= '" title="status">
                        ...
                        <select autocomplete="off" class="codemainfzr" id="actions' . esc_html($cont) . '" class="actions" name="actions" onchange="actionsChangedManual(' . esc_html($cont) . ', this.value, 5, \'' . esc_html($rule_unique_id) . '\');" onfocus="this.selectedIndex = 0;">
