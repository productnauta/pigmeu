...
if(!class_exists('AiomaticFineTune'))
{
    class AiomaticFineTune
    {
        ...
        {
            $model = isset($_POST['model']) && !empty($_POST['model']) ? sanitize_text_field($_POST['model']) : AIOMATIC_DEFAULT_MODEL;
        ...
        public function aiomatic_data_converter_count()
        {
            ...
            if(isset($_POST['data']) && is_array($_POST['data']) && count($_POST['data'])){
                ...
                {
                    $model = AIOMATIC_DEFAULT_TRAINING_MODEL;
                }
            ...
            if(
                ...
                try {
                    ...
                    if($aiomatic_data && is_array($aiomatic_data) && count($aiomatic_data))
                    {
                        ...
                        {
                            if(in_array($aiomatic_model, AIOMATIC_TRAINING_MODELS_CHAT))
                            {
            ...
            if(isset($_POST['id']) && !empty($_POST['id'])){
                ...
                if($aiomatic_file){
                    ...
                    if(empty($dataSend['model'])){
                        $dataSend['model'] = AIOMATIC_DEFAULT_MODEL;
                    }
