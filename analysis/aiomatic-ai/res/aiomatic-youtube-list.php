<?php
   function aiomatic_youtube_panel()
   {
...
<div class="wrap">
        <h1><?php echo esc_html__("YouTube Videos To Posts", 'aiomatic-automatic-ai-content-writer');?></h1>
    </div>
<?php
            ...
            <div class="hideMain">
               ...
               <div class="table-responsive">
                  <table id="mainRules" class="responsive table cr_main_table">
                     ...
                     <tbody>
                        <?php
                           echo aiomatic_expand_rules_youtube();
                        ...
                        <tr>
                           <td class="cr_short_td"><input type="text" name="aiomatic_youtube_list[rule_description][]" id="rule_description" class="cr_center" placeholder="Rule ID" value="" class="cr_width_full"/></td>
                           <td class="cr_loi"><textarea rows="1" name="aiomatic_youtube_list[url_list][]" placeholder="https://www.youtube.com/watch?v=..." class="cr_width_full"></textarea></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="1" name="aiomatic_youtube_list[schedule][]" max="8765812" class="cr_width_60" placeholder="Select the rule schedule interval" value="24"/></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="0" name="aiomatic_youtube_list[max][]" class="cr_width_60" placeholder="Select the # of generated posts" value="1" /></td>
                                       ...
                                       <div class="table-responsive">
                                          ...
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td><select id="assistant_id" name="aiomatic_youtube_list[assistant_id][]" class="cr_width_full" onchange="assistantSelected('');">
    <?php
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_youtube_list[default_lang][]" value="" placeholder="Please insert a language list for video captions" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="number" min="0" name="aiomatic_youtube_list[max_caption][]" value="3000" placeholder="Caption maximum length" class="cr_width_full">  
                                                </td>
                                             </tr>
                                             <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="checkbox" id="ai_titles" name="aiomatic_youtube_list[ai_titles][]">
                                                </td>
                                             </tr> 
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[post_sections_list][]" placeholder="Post sections list (one per line)" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <input type="text" id="section_count" name="aiomatic_youtube_list[section_count][]" placeholder="3-4" class="cr_width_full" value="3-4">  
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="sections_role" name="aiomatic_youtube_list[sections_role][]">
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <input type="text" id="paragraph_count" name="aiomatic_youtube_list[paragraph_count][]" placeholder="2-3" class="cr_width_full" value="2">  
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_youtube_list[topic_images][]" value="" placeholder="Number of images" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="img_all_headings" name="aiomatic_youtube_list[img_all_headings][]" checked>
                                                </td>
                                             </tr> 
                                             <tr>
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="heading_img_location" name="aiomatic_youtube_list[heading_img_location][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="checkbox" id="topic_videos" name="aiomatic_youtube_list[topic_videos][]">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                             ...
                                             <tr>
                                                ...
                                                <td class="hideTOC-1">
                                                <input type="checkbox" id="enable_toc" name="aiomatic_youtube_list[enable_toc][]">
                                                </td>
                                             </tr> 
                                             <tr>
                                                <td class="hideTOC-1">
                                                ...
                                                <td class="hideTOC-1">
                                                <input type="text" name="aiomatic_youtube_list[title_toc][]" value="Table of Contents" placeholder="Table of Contents" class="cr_width_full">
                                                </td>
                                             </tr> 
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="enable_qa" name="aiomatic_youtube_list[enable_qa][]">
                                                </td>
                                             </tr> 
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_youtube_list[title_qa][]" value="Q&A" placeholder="Q&A" class="cr_width_full">
                                                </td>
                                             </tr> 
                                             <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input id="content_language" name="aiomatic_youtube_list[content_language][]" type="text" list="languages" placeholder="Created content language" class="coderevolution_gutenberg_input" value="English"/>
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input id="writing_style" name="aiomatic_youtube_list[writing_style][]" type="text" placeholder="Created content writing style" list="writing_styles" class="coderevolution_gutenberg_input" value="Creative"/>
...
<option>Research</option>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input id="writing_tone" name="aiomatic_youtube_list[writing_tone][]" type="text" list="writing_tones" placeholder="Created content writing tone" class="coderevolution_gutenberg_input" value="Neutral"/>
...
<option>Serious</option>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_title_model" name="aiomatic_youtube_list[topic_title_model][]" class="hideAssistant cr_width_full">
                                                <?php
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[intro_prompt][]" placeholder="Enter your intro prompts, one per line" class="cr_width_full">Write an introduction for a blog post which talks about the topics discussed in the YouTube video with the following title: "%%video_title%%", in %%language%%. Style: %%writing_style%%. Tone: %%writing_tone%%. The YouTube video has the following transcript: "%%video_captions%%"</textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_intro_model" name="aiomatic_youtube_list[topic_intro_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[sections_prompt][]" placeholder="Enter your sections prompts, one per line" class="cr_width_full">Write %%sections_count%% consecutive headings that highlight specific aspects, provide detailed insights and specific recommendations for a blog post which talks about the topics discussed in the YouTube video with the following title: "%%video_title%%", in %%language%%. Style: %%writing_style%%. Tone: %%writing_tone%%. Don't add numbers to the headings, hyphens or any types of quotes. Return only the headings list, nothing else. Extract ideas from the following video transcript: "%%video_captions%%"</textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_sections_model" name="aiomatic_youtube_list[topic_sections_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_content_model" name="aiomatic_youtube_list[topic_content_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="checkbox" id="single_content_call-1" name="aiomatic_youtube_list[single_content_call][]" onclick="hideTOC(-1);">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[qa_prompt][]" placeholder="Enter your Q&A prompts, one per line" class="cr_width_full">Write a Q&A for a blog post which talks about the topics discussed in the YouTube video with the following title: "%%video_title%%", in %%language%%. Style: %%writing_style%%. Tone: %%writing_tone%%. The YouTube video has the following transcript: "%%video_captions%%"</textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_qa_model" name="aiomatic_youtube_list[topic_qa_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_outro_model" name="aiomatic_youtube_list[topic_outro_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[excerpt_prompt][]" placeholder="Enter your excerpt prompts, one per line" class="cr_width_full">Write a short excerpt for a blog post which talks about the topics discussed in the YouTube video with the following title: "%%video_title%%" in %%language%%. Style: %%writing_style%%. Tone: %%writing_tone%%. Must be between 150 and 250 characters. The YouTube video has the following transcript: "%%video_captions%%"</textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="topic_excerpt_model" name="aiomatic_youtube_list[topic_excerpt_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <textarea rows="1" class="cr_width_full" name="aiomatic_youtube_list[strip_by_regex_prompts][]" placeholder="regex expression" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <textarea rows="1" class="cr_width_full" name="aiomatic_youtube_list[replace_regex_prompts][]" placeholder="regex replacement" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input id="run_regex_on" name="aiomatic_youtube_list[run_regex_on][]" type="text" list="run_regex_on_list" class="coderevolution_gutenberg_input" value="content"/>
                     ...
                     <option value="excerpt">excerpt</option>
                                          ...
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[global_prepend][]" placeholder="Global prompt prepend text" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[global_append][]" placeholder="Global prompt append text" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="link_type" onchange="hideLinks('');" name="aiomatic_youtube_list[link_type][]">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_youtube_list[max_links][]" placeholder="Add the number of links to enable this feature" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr class="hidelinks">
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="1" cols="70" name="aiomatic_youtube_list[link_list][]" placeholder="URL list (one per line)" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr class="hidelinks">
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="checkbox" id="link_nofollow" name="aiomatic_youtube_list[link_nofollow][]">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_youtube_list[link_post_types][]" placeholder="post" class="cr_width_full">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="auto_categories" name="aiomatic_youtube_list[auto_categories][]">
                                                <option value="disabled" selected><?php echo esc_html__("Disabled", 'aiomatic-automatic-ai-content-writer');?></option>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="category_model" name="aiomatic_youtube_list[category_model][]" class="hideAssistant cr_width_full">
                                                <?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                             <select multiple id="default_category" name="aiomatic_youtube_list[default_category][]" class="cr_width_full" onmouseover="this.size=this.length;" onmouseout="this.size=4;">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="checkbox" id="remove_default" name="aiomatic_youtube_list[remove_default][]" checked>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="skip_inexist" name="aiomatic_youtube_list[skip_inexist][]">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" class="cr_width_full" id="auto_tags" name="aiomatic_youtube_list[auto_tags][]">
                                                <option value="disabled" selected><?php echo esc_html__("Disabled", 'aiomatic-automatic-ai-content-writer');?></option>
                                                <option value="ai"><?php echo esc_html__("AI Generated", 'aiomatic-automatic-ai-content-writer');?></option>
                                                <option value="hashtags"><?php echo esc_html__("Title", 'aiomatic-automatic-ai-content-writer');?></option>
                                                <option value="content"><?php echo esc_html__("Content", 'aiomatic-automatic-ai-content-writer');?></option>
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="tag_model" name="aiomatic_youtube_list[tag_model][]" class="hideAssistant cr_width_full">
<?php
foreach($all_models as $modelx)
{
   echo '<option value="' . esc_html($modelx) .'"';
...
?>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="text" name="aiomatic_youtube_list[default_tags][]" value="" placeholder="Please insert your additional post tags here" class="cr_width_full">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_youtube_list[max_tokens][]" value="" placeholder="2048" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_youtube_list[max_seed_tokens][]" value="" placeholder="1000" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="1" name="aiomatic_youtube_list[max_continue_tokens][]" value="" placeholder="500" class="cr_width_full">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <input type="number" min="0" step="0.01" max="2" name="aiomatic_youtube_list[temperature][]" value="" placeholder="1" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="0" max="1" step="0.01" name="aiomatic_youtube_list[top_p][]" value="" placeholder="1" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="-2" step="0.01" max="2" name="aiomatic_youtube_list[presence_penalty][]" value="" placeholder="0" class="cr_width_full">
                                                </td>
                                             </tr><tr>
                                                <td class="cr_min_width_200">
                                                      <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                                ...
                                                <td>
                                                <input type="number" min="0" max="2" step="0.01" name="aiomatic_youtube_list[frequency_penalty][]" value="" placeholder="0" class="cr_width_full">
                                                </td>
                                             </tr>
                                          <tr><td colspan="2">
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                             <select autocomplete="off" id="royalty_free" name="aiomatic_youtube_list[royalty_free][]" class="cr_width_full">
                                                   ...
                                                   <option value="2" selected><?php echo esc_html__("YouTube Video Thumbnail", 'aiomatic-automatic-ai-content-writer');?></option>
                                                </select>
                                             </td>
                                          </tr>
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" id="search_query_repetition" name="aiomatic_youtube_list[search_query_repetition][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <select autocomplete="off" id="enable_ai_images" onchange="hideImage('');" name="aiomatic_youtube_list[enable_ai_images][]" class="cr_width_full">
                                             ...
                                             <tr class="hideDalle cr_none">
                                                ...
                                                <td>
                                                <select autocomplete="off" id="image_model" name="aiomatic_youtube_list[image_model][]" class="cr_width_full">
                                             ...
                                             <tr class="hideImg cr_none">
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="model" name="aiomatic_youtube_list[image_size][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <textarea rows="1" class="cr_width_60p" name="aiomatic_youtube_list[image_url][]" placeholder="Please insert the link to a valid image (spintax supported)"></textarea>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[post_prepend][]" placeholder="HTML content to prepend to the AI generated content" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[post_append][]" placeholder="HTML content to append to the AI generated content" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="2" cols="70" name="aiomatic_youtube_list[custom_shortcodes][]" placeholder="shortcode_name => AI_MODEL @@ AI_PROMPT" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="strip_title" name="aiomatic_youtube_list[strip_title][]">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="skip_spin" name="aiomatic_youtube_list[skip_spin][]">               
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="skip_translate" name="aiomatic_youtube_list[skip_translate][]">               
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                      ...
                                                      <b><?php echo esc_html__("Process Each Title/Video Only Once:", 'aiomatic-automatic-ai-content-writer');?></b>
                                                </td>
                                                <td>
                                                <input type="checkbox" id="title_once" name="aiomatic_youtube_list[title_once][]" checked>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="overwrite_existing" name="aiomatic_youtube_list[overwrite_existing][]">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="no_random" name="aiomatic_youtube_list[no_random][]">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <textarea rows="1" class="cr_width_full" name="aiomatic_youtube_list[strip_by_regex][]" placeholder="regex expression" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <textarea rows="1" class="cr_width_full" name="aiomatic_youtube_list[replace_regex][]" placeholder="regex replacement" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="post_author" name="aiomatic_youtube_list[post_author][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="submit_status" name="aiomatic_youtube_list[submit_status][]" class="cr_width_full">
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="default_type" name="aiomatic_youtube_list[default_type][]" class="cr_width_full" onchange="go_change_cats(this, '');">
                                                <?php
                                                   $is_first = true;
                                             ...
                                             <tr>
                                                ...
                                                <td class="cr_min_width_200">
                                                <select autocomplete="off" id="post_format" name="aiomatic_youtube_list[post_format][]" class="cr_width_full">
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                             <input type="number" min="1" class="cr_width_full" name="aiomatic_youtube_list[parent_id][]" value="" placeholder="Post parent ID" class="cr_width_full">
                                             </td>
                                          </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="enable_comments" name="aiomatic_youtube_list[enable_comments][]" checked>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="checkbox" id="enable_pingback" name="aiomatic_youtube_list[enable_pingback][]" checked>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                <input type="text" id="min_time" name="aiomatic_youtube_list[min_time][]" placeholder="Start time" class="cr_half"> - <input type="text" id="max_time" name="aiomatic_youtube_list[max_time][]" placeholder="End time" class="cr_half">
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="1" cols="70" name="aiomatic_youtube_list[custom_fields][]" placeholder="Please insert your desired custom fields. Example: title_custom_field => %%post_title%%" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td class="cr_min_width_200">
                                                ...
                                                <td>
                                                <textarea rows="1" cols="70" name="aiomatic_youtube_list[custom_tax][]" placeholder="Please insert your desired custom taxonomies. Example: custom_taxonomy_name => %%post_title%%" class="cr_width_full"></textarea>
                                                </td>
                                             </tr>
                                          <tr>
                                             <td>
                                             ...
                                             <td>
                                             <input type="text" class="cr_width_full" name="aiomatic_youtube_list[wpml_lang][]" value="" placeholder="WPML/Polylang language" class="cr_width_full">
                                             </td>
                                          </tr>
                                             <tr><td colspan="2">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                <input type="text" class="cr_width_full" name="aiomatic_youtube_list[days_no_run][]" value="" placeholder="Mo,Tu,We,Th,Fr,Sa,Su" class="cr_width_full">  
                                                </td>
                                             </tr>
                                          </table>
                                       </div>
                           ...
                           <td class="cr_short_td"><input type="checkbox" name="aiomatic_youtube_list[active][]" value="1" checked />
                              <input type="hidden" name="aiomatic_youtube_list[last_run][]" value="1988-01-27 00:00:00"/>
                           <input type="hidden" name="aiomatic_youtube_list[rule_unique_id][]" value="<?php echo esc_html(uniqid('', true));?>"/>
                           </td>
...
?>
<div class="wrap">
        <h3><?php echo esc_html__("YouTube Videos To Posts Tutorial Video", 'aiomatic-automatic-ai-content-writer');?></h3>
        <div id="ai-video-container"><br/>
            <iframe class="ai-video" width="560" height="315" src="https://www.youtube.com/embed/MWpu_ly5ZKE" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
<?php
   }
}
   if (isset($_POST['aiomatic_youtube_list'])) {
       add_action('admin_init', 'aiomatic_save_rules_youtube');
   }
   
   function aiomatic_save_rules_youtube($data2)
   {
       ...
       $data2 = $_POST['aiomatic_youtube_list'];
       $rules = get_option('aiomatic_youtube_list', array());
       if(!is_array($rules))
       {
          $rules = array();
       }
       ...
       $cat_cont = $offset;
       $cont  = 0;
       if (isset($data2['url_list'][0])) {
           for ($i = 0; $i < sizeof($data2['url_list']); ++$i) 
           {
               $bundle = array();
               if (isset($data2['schedule'][$i]) && $data2['schedule'][$i] != '' && $data2['url_list'][$i] != '') {
                   ...
                   $bundle[]     = trim($data2['default_lang'][$i]);
                   $bundle[]     = trim($data2['ai_titles'][$i]);
                   ...
                   $bundle[]     = trim($data2['max_caption'][$i]);
   ...
   function aiomatic_expand_rules_youtube()
   {
       $all_models = aiomatic_get_all_models(true);
       $all_assistants = aiomatic_get_all_assistants(true);
       ...
       if (!empty($rules)) {
            ...
            foreach ($rules as $request => $bundle[]) {
               ...
               $default_lang           = $array_my_values[43];
               $ai_titles              = $array_my_values[44];
               $post_sections_list     = $array_my_values[45];
               $content_language       = $array_my_values[46];
               $writing_style          = $array_my_values[47];
               $writing_tone           = $array_my_values[48];
               $title_prompt           = $array_my_values[49];
               $sections_prompt        = $array_my_values[50];
               $content_prompt         = $array_my_values[51];
               $excerpt_prompt         = $array_my_values[52];
               $section_count          = $array_my_values[53];
               $paragraph_count        = $array_my_values[54];
               $topic_title_model      = $array_my_values[55];
               $topic_sections_model   = $array_my_values[56];
               $topic_content_model    = $array_my_values[57];
               $topic_excerpt_model    = $array_my_values[58];
               $single_content_call    = $array_my_values[59];
               $intro_prompt           = $array_my_values[60];
               $topic_intro_model      = $array_my_values[61];
               $outro_prompt           = $array_my_values[62];
               $topic_outro_model      = $array_my_values[63];
               $topic_images           = $array_my_values[64];
               $sections_role          = $array_my_values[65];
               $topic_videos           = $array_my_values[66];
               $rule_description       = $array_my_values[67];
               $custom_shortcodes      = $array_my_values[68];
               $strip_by_regex         = $array_my_values[69];
               $replace_regex          = $array_my_values[70];
               $strip_by_regex_prompts = $array_my_values[71];
               $replace_regex_prompts  = $array_my_values[72];
               $run_regex_on           = $array_my_values[73];
               $max_links              = $array_my_values[74];
               $link_post_types        = $array_my_values[75];
               $enable_toc             = $array_my_values[76];
               $title_toc              = $array_my_values[77];
               $qa_prompt              = $array_my_values[78];
               $topic_qa_model         = $array_my_values[79];
               $enable_qa              = $array_my_values[80];
               $title_qa               = $array_my_values[81];
               $title_outro            = $array_my_values[82];
               $link_type              = $array_my_values[83];
               $link_list              = $array_my_values[84];
               $skip_inexist           = $array_my_values[85];
               $max_caption            = $array_my_values[86];
               $global_prepend         = $array_my_values[87];
               $global_append          = $array_my_values[88];
               $search_query_repetition= $array_my_values[89];
               $img_all_headings       = $array_my_values[90];
               $heading_img_location   = $array_my_values[91];
               $days_no_run            = $array_my_values[92];
               $no_random              = $array_my_values[93];
               $overwrite_existing     = $array_my_values[94];
               $link_nofollow          = $array_my_values[95];
               $parent_id              = $array_my_values[96];
               $rule_unique_id         = $array_my_values[97];
               $image_model            = $array_my_values[98];
               $assistant_id           = $array_my_values[99];
               ...
               $output .= '<tr>
                           <td class="cr_short_td"><input type="text" name="aiomatic_youtube_list[rule_description][]" id="rule_description' . esc_html($cont) . '" class="cr_center" placeholder="Rule ID" value="' . esc_html($rule_description) . '" class="cr_width_full"/></td>
                           <td class="cr_loi"><textarea rows="1" name="aiomatic_youtube_list[url_list][]" placeholder="https://www.youtube.com/watch?v=..." class="cr_width_full">' . htmlspecialchars($url_list) . '</textarea></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="1" placeholder="# h" name="aiomatic_youtube_list[schedule][]" max="8765812" value="' . esc_attr($schedule) . '" class="cr_width_60" required></td>
                           <td class="cr_comm_td"><input type="number" step="1" min="0" placeholder="#" name="aiomatic_youtube_list[max][]" value="' . esc_attr($max) . '"  class="cr_width_60" required></td>
                       <td class="cr_width_70 cr_center">
     ...
     <div class="codemodalfzr-content">
       ...
       <div class="table-responsive">
         ...
         <td><select id="assistant_id' . esc_html($cont) . '" name="aiomatic_youtube_list[assistant_id][]" class="cr_width_full" onchange="assistantSelected(\'' . esc_html($cont) . '\');">';
if($all_assistants === false)
{
...
$output .= '</select>  
         ...
         <tr><td colspan="2"><h3>' . esc_html__('YouTube Video Options', 'aiomatic-automatic-ai-content-writer') . ':</h3></td></tr><tr><td>
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Input a comma separated list of video captions prefered languages to use for the %%video_caption%% shortcode. Please use a comma separated list of 2 character language codes. Ex: en,es,hu,br. The plugin will use the fisrt language in the list that matches. If you leave this field blank, the default language caption will be imported for each video.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("Video Caption Preferred Languages", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     </td><td>
                     <input type="text" name="aiomatic_youtube_list[default_lang][]" value="' . esc_attr($default_lang) . '" placeholder="Please insert a language list for video captions" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <b>' . esc_html__("Video Caption Maximum Character Length In Prompts", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     </td><td>
                     <input type="number" min="0" name="aiomatic_youtube_list[max_caption][]" value="' . esc_attr($max_caption) . '" placeholder="Caption maximum length" class="cr_width_full">
         ...
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Select if you want to use AI generated titles for the posts created by the plugin. If not, the YouTube video title will be used.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("Use AI Generated Post Titles", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     
                     </td><td>
                     <input type="checkbox" id="ai_titles' . esc_html($cont) . '" name="aiomatic_youtube_list[ai_titles][]"';
         if($ai_titles == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[post_sections_list][]" placeholder="Post sections list (one per line)" class="cr_width_full">' . esc_textarea($post_sections_list) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="text" id="section_count' . esc_html($cont) . '" name="aiomatic_youtube_list[section_count][]" placeholder="3-4" class="cr_width_full" value="' . esc_attr($section_count) . '">
         </div>
         </td></tr>
         <tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" class="cr_width_full" id="sections_role' . esc_html($cont) . '" name="aiomatic_youtube_list[sections_role][]">
                       <option value="h2"';
               if ($sections_role == 'h2') {
                   $output .= ' selected';
               }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="text" id="paragraph_count' . esc_html($cont) . '" name="aiomatic_youtube_list[paragraph_count][]" placeholder="2-3" class="cr_width_full" value="' . esc_attr($paragraph_count) . '">
         </div>
         </td></tr>
         <tr><td class="cr_min_width_200">
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="text" name="aiomatic_youtube_list[topic_images][]" value="' . esc_attr($topic_images) . '" placeholder="Number of images" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="img_all_headings' . esc_html($cont) . '" name="aiomatic_youtube_list[img_all_headings][]"';
         ...
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Select the location of the heading images.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("Heading Image Location", 'aiomatic-automatic-ai-content-writer') . ':</b>   
                     </td><td class="cr_min_width_200">
                     <select autocomplete="off" id="heading_img_location' . esc_html($cont) . '" name="aiomatic_youtube_list[heading_img_location][]" class="cr_width_full">
                                    <option value="top"';
         ...
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                         <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Select if you would like to add the source YouTube video to the end of the created article.", 'aiomatic-automatic-ai-content-writer') . '
                         </div>
                     </div>
                     <b>' . esc_html__("Add The YouTube Video To The Article", 'aiomatic-automatic-ai-content-writer') . ':</b>
                     </td><td>
                     <input type="checkbox" id="topic_videos' . esc_html($cont) . '" name="aiomatic_youtube_list[topic_videos][]"';
         if($topic_videos == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="title_outro' . esc_html($cont) . '" name="aiomatic_youtube_list[title_outro][]" type="text" placeholder="Optional" class="coderevolution_gutenberg_input" value="' . esc_attr($title_outro) . '"/>           
         </div>
         </td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_toc' . esc_html($cont) . '" name="aiomatic_youtube_list[enable_toc][]"';
         if($enable_toc == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="title_toc' . esc_html($cont) . '" name="aiomatic_youtube_list[title_toc][]" type="text" placeholder="Table of Contents" class="coderevolution_gutenberg_input" value="' . esc_attr($title_toc) . '"/>           
         </div>
         </td></tr>
         <tr><td>
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="enable_qa' . esc_html($cont) . '" name="aiomatic_youtube_list[enable_qa][]"';
         if($enable_qa == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="title_qa' . esc_html($cont) . '" name="aiomatic_youtube_list[title_qa][]" type="text" placeholder="Q&A" class="coderevolution_gutenberg_input" value="' . esc_attr($title_qa) . '"/>           
         </div>
         </td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="content_language' . esc_html($cont) . '" name="aiomatic_youtube_list[content_language][]" type="text" list="languages" placeholder="Created content language" class="coderevolution_gutenberg_input" value="' . esc_attr($content_language) . '"/>                         
         </div>
         </td></tr>
         <tr><td class="cr_min_width_200">
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="writing_style' . esc_html($cont) . '" name="aiomatic_youtube_list[writing_style][]" type="text" list="writing_styles" placeholder="Created content writing style" class="coderevolution_gutenberg_input" value="' . esc_attr($writing_style) . '"/>                         
         </div>
         </td></tr>
         <tr><td class="cr_min_width_200">
         <div>
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="writing_tone' . esc_html($cont) . '" name="aiomatic_youtube_list[writing_tone][]" type="text" list="writing_tones" placeholder="Created content writing tone" class="coderevolution_gutenberg_input" value="' . esc_attr($writing_tone) . '"/>                         
         </div>
         </td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[title_prompt][]" placeholder="Enter your title prompts, one per line" class="cr_width_full">' . esc_textarea($title_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[topic_title_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[intro_prompt][]" placeholder="Enter your intro prompts, one per line" class="cr_width_full">' . esc_textarea($intro_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[topic_intro_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[sections_prompt][]" placeholder="Enter your sections prompts, one per line" class="cr_width_full">' . esc_textarea($sections_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[topic_sections_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="3" cols="70" name="aiomatic_youtube_list[content_prompt][]" placeholder="Enter your content prompt" class="cr_width_full">' . esc_textarea($content_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[topic_content_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="single_content_call' . esc_html($cont) . '" name="aiomatic_youtube_list[single_content_call][]"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[qa_prompt][]" placeholder="Enter your Q&A prompts, one per line" class="cr_width_full">' . esc_textarea($qa_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[topic_qa_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[outro_prompt][]" placeholder="Enter your outro prompts, one per line" class="cr_width_full">' . esc_textarea($outro_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[topic_outro_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[excerpt_prompt][]" placeholder="Enter your excerpt prompts, one per line" class="cr_width_full">' . esc_textarea($excerpt_prompt) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[topic_excerpt_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="1" class="cr_width_full" name="aiomatic_youtube_list[strip_by_regex_prompts][]" placeholder="regex" class="cr_width_full">' . esc_textarea($strip_by_regex_prompts) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="1" class="cr_width_full" name="aiomatic_youtube_list[replace_regex_prompts][]" placeholder="regex replacement" class="cr_width_full">' . esc_textarea($replace_regex_prompts) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input id="run_regex_on' . esc_html($cont) . '" name="aiomatic_youtube_list[run_regex_on][]" type="text" list="run_regex_on_list' . esc_html($cont) . '" class="coderevolution_gutenberg_input" value="' . esc_attr($run_regex_on) . '"/>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[global_prepend][]" placeholder="Global prompt prepend text" class="cr_width_full">' . esc_textarea($global_prepend) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[global_append][]" placeholder="Global prompt append text" class="cr_width_full">' . esc_textarea($global_append) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" class="cr_width_full" id="link_type' . esc_html($cont) . '" onchange="hideLinks(' . esc_html($cont) . ');" name="aiomatic_youtube_list[link_type][]">
         ...
         <tr><td class="cr_min_width_200">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" name="aiomatic_youtube_list[max_links][]" placeholder="Add the number of links to enable this feature" class="cr_width_full" value="' . esc_attr($max_links) . '">
           </div>
           </td></tr>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="1" cols="70" name="aiomatic_youtube_list[link_list][]" placeholder="URL list (one per line)" class="cr_width_full">' . esc_textarea($link_list) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" name="aiomatic_youtube_list[link_nofollow][]"';
         if($link_nofollow == '1')
         {
             $output .= ' checked';
         }
         ...
         <tr><td class="cr_min_width_200">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" name="aiomatic_youtube_list[link_post_types][]" placeholder="post" class="cr_width_full" value="' . esc_attr($link_post_types) . '">
           </div>
           </td></tr>
         ...
         <tr><td>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" class="cr_width_full" id="auto_categories' . esc_html($cont) . '" name="aiomatic_youtube_list[auto_categories][]">
                       <option value="disabled"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[category_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[category_ai_command][]" placeholder="Write a comma separated list of categories, for the post title: %%post_title%%" class="cr_width_full">' . esc_textarea($category_ai_command) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select multiple class="cr_width_full" id="default_category' . esc_html($cont) . '" name="aiomatic_youtube_list[default_category' . esc_html($cont) . '][]" onmouseover="this.size=this.length;" onmouseout="this.size=4;">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="remove_default' . esc_html($cont) . '" name="aiomatic_youtube_list[remove_default][]"';
         if($remove_default == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="checkbox" id="skip_inexist' . esc_html($cont) . '" name="aiomatic_youtube_list[skip_inexist][]"';
         if($skip_inexist == '1')
         {
             $output .= ' checked';
         }
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" class="cr_width_full" id="auto_tags' . esc_html($cont) . '" name="aiomatic_youtube_list[auto_tags][]">
                     <option value="disabled"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[tag_model][]" class="hideAssistant' . esc_html($cont) . ' cr_width_full">';
if(empty($tag_model))
{
...
foreach($all_models as $modelx)
{
   ...
   $output .= '>' . esc_html($modelx) . esc_html(aiomatic_get_model_provider($modelx)) . '</option>';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[tag_ai_command][]" placeholder="Write a comma separated list of tags, for the post title: %%post_title%%" class="cr_width_full">' . esc_textarea($tag_ai_command) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input class="cr_width_full" type="text" name="aiomatic_youtube_list[default_tags][]" value="' . esc_attr($default_tags) . '" placeholder="Please insert your additional post tags here" >
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_youtube_list[max_tokens][]" value="' . esc_attr($max_tokens) . '" placeholder="2048" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_youtube_list[max_seed_tokens][]" value="' . esc_attr($max_seed_tokens) . '" placeholder="1000" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="1" name="aiomatic_youtube_list[max_continue_tokens][]" value="' . esc_attr($max_continue_tokens) . '" placeholder="500" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="0" step="0.01" max="2" name="aiomatic_youtube_list[temperature][]" value="' . esc_attr($temperature) . '" placeholder="1" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="0" step="0.01" max="1" name="aiomatic_youtube_list[top_p][]" value="' . esc_attr($top_p) . '" placeholder="1" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="-2" max="2" step="0.01" name="aiomatic_youtube_list[presence_penalty][]" value="' . esc_attr($presence_penalty) . '" placeholder="0" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <input type="number" min="-2" step="0.01" max="2" name="aiomatic_youtube_list[frequency_penalty][]" value="' . esc_attr($frequency_penalty) . '" placeholder="0" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[royalty_free][]" class="cr_width_full">
                                   <option value="0"';
             if ($royalty_free == '0') {
                 $output .= ' selected';
             }
             ...
             $output .= '>' . esc_html__("YouTube Video Thumbnail", 'aiomatic-automatic-ai-content-writer') . '</option>
                     </select>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[search_query_repetition][]" class="cr_width_full">
                                   <option value="0"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select id="enable_ai_images' . esc_html($cont) . '" autocomplete="off" onchange="hideImage(' . esc_html($cont) . ');" name="aiomatic_youtube_list[enable_ai_images][]" class="cr_width_full">
                                   <option value="0"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="2" cols="70" name="aiomatic_youtube_list[ai_command_image][]" placeholder="Please insert a command for the AI image generator" class="cr_width_full">' . esc_textarea($ai_command_image) . '</textarea>
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[image_model][]" class="cr_width_full">
                                   <option value="dalle2"';
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <select autocomplete="off" name="aiomatic_youtube_list[image_size][]" class="cr_width_full">
         ...
         <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                     ...
                     <textarea rows="1" class="cr_width_60p" name="aiomatic_youtube_list[image_url][]" placeholder="Please insert the link to a valid image (spintax supported)">' . esc_textarea($image_url) . '</textarea>
         ...
         <tr><td colspan="2"><h3>' . esc_html__('Posting Options', 'aiomatic-automatic-ai-content-writer') . ':</h3></td></tr>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="2" cols="70" name="aiomatic_youtube_list[post_prepend][]" placeholder="HTML content to prepend to the AI generated content" class="cr_width_full">' . esc_textarea($post_prepend) . '</textarea>
           </div>
           </td></tr><tr><td class="cr_min_width_200">
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="2" cols="70" name="aiomatic_youtube_list[post_append][]" placeholder="HTML content to append to the AI generated content" class="cr_width_full">' . esc_textarea($post_append) . '</textarea>
           </div>
           </td></tr><tr><td class="cr_min_width_200">
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="2" cols="70" name="aiomatic_youtube_list[custom_shortcodes][]" placeholder="shortcode_name => AI_MODEL @@ AI_PROMPT" class="cr_width_full">' . esc_textarea($custom_shortcodes) . '</textarea>
           </div>
           </td></tr><tr><td>
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="strip_title' . esc_html($cont) . '" name="aiomatic_youtube_list[strip_title][]"';
           if($strip_title == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="skip_spin' . esc_html($cont) . '" name="aiomatic_youtube_list[skip_spin][]"';
           if($skip_spin == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="skip_translate' . esc_html($cont) . ' name="aiomatic_youtube_list[skip_translate][]"';
           if($skip_translate == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Process Each Title/Video Only Once", 'aiomatic-automatic-ai-content-writer') . ':</b>
                       
                       </td><td>
                       <input type="checkbox" id="title_once' . esc_html($cont) . '" name="aiomatic_youtube_list[title_once][]"';
           if($title_once == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="overwrite_existing' . esc_html($cont) . '" name="aiomatic_youtube_list[overwrite_existing][]"';
           ...
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                                           <div class="bws_hidden_help_text cr_min_260px">' . esc_html__("Select if you want to process added YouTube videos in order of entry or in random order.", 'aiomatic-automatic-ai-content-writer') . '
                           </div>
                       </div>
                       <b>' . esc_html__("Process Videos In Order Of Entry", 'aiomatic-automatic-ai-content-writer') . ':</b>
                       
                       </td><td>
                       <input type="checkbox" id="no_random' . esc_html($cont) . '" name="aiomatic_youtube_list[no_random][]"';
           if($no_random == '1')
           {
               $output .= ' checked';
           }
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" class="cr_width_full" name="aiomatic_youtube_list[strip_by_regex][]" placeholder="regex" class="cr_width_full">' . esc_textarea($strip_by_regex) . '</textarea>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" class="cr_width_full" name="aiomatic_youtube_list[replace_regex][]" placeholder="regex replacement" class="cr_width_full">' . esc_textarea($replace_regex) . '</textarea>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="post_author' . esc_html($cont) . '" name="aiomatic_youtube_list[post_author][]" class="cr_width_full">';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="submit_status' . esc_html($cont) . '" name="aiomatic_youtube_list[submit_status][]" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="default_type' . esc_html($cont) . '" name="aiomatic_youtube_list[default_type][]" class="cr_width_full" onchange="go_change_cats(this, \'' . esc_html($cont) . '\');">';
               foreach ( get_post_types( '', 'names' ) as $post_type ) {
                  if(strstr($post_type, 'aiomatic_'))
                  {
                     continue;
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <select autocomplete="off" id="post_format' . esc_html($cont) . '" name="aiomatic_youtube_list[post_format][]" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" class="cr_width_full" name="aiomatic_youtube_list[parent_id][]" value="' . esc_attr($parent_id) . '" placeholder="Post parent ID" class="cr_width_full">
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_comments' . esc_html($cont) . '" name="aiomatic_youtube_list[enable_comments][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="checkbox" id="enable_pingback' . esc_html($cont) . '" name="aiomatic_youtube_list[enable_pingback][]"';
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <input type="text" id="min_time' . esc_html($cont) . '" name="aiomatic_youtube_list[min_time][]" placeholder="Start time" value="' . esc_attr($min_time) . '" class="cr_half"> - <input type="text" id="max_time' . esc_html($cont) . '" name="aiomatic_youtube_list[max_time][]" value="' . esc_attr($max_time) . '" placeholder="End time" class="cr_half">   
           </div>
           </td></tr><tr><td class="cr_min_width_200">
           <div>
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <textarea rows="1" cols="70" name="aiomatic_youtube_list[custom_fields][]" placeholder="Please insert your desired custom fields. Example: title_custom_field => %%post_title%%" class="cr_width_full">' . esc_textarea($custom_fields) . '</textarea>
           ...
           <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                       ...
                       <b>' . esc_html__("Post Custom Taxonomies", 'aiomatic-automatic-ai-content-writer') . ':</b>&nbsp;<b><a href="https://coderevolution.ro/knowledge-base/faq/post-template-reference-advanced-usage/" target="_blank">&#9432;</a></b>
                         ...
                         <textarea rows="1" cols="70" name="aiomatic_youtube_list[custom_tax][]" placeholder="Please insert your desired custom taxonomies. Example: custom_taxonomy_name => %%post_title%%" class="cr_width_full">' . esc_textarea($custom_tax) . '</textarea>  
           </div>
           </td></tr><tr><td>
           <div>
          <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                      ...
                      <input type="text" class="cr_width_full" name="aiomatic_youtube_list[wpml_lang][]" value="' . esc_attr($wpml_lang) . '" placeholder="WPML/Polylang language" class="cr_width_full">
          ...
          <div class="bws_help_box bws_help_box_right dashicons dashicons-editor-help cr_align_middle">
                      ...
                      <input type="text" class="cr_width_full" name="aiomatic_youtube_list[days_no_run][]" value="' . esc_attr($days_no_run) . '" placeholder="Mo,Tu,We,Th,Fr,Sa,Su" class="cr_width_full">
          </div>
          </td></tr></table></div> 
       </div>
       <div class="codemodalfzr-footer">
         ...
         <br/><br/>
                           ...
                           <td class="cr_short_td"><input type="checkbox" name="aiomatic_youtube_list[active][]" class="activateDeactivateClass" value="1"';
               if (isset($active) && $active === '1') {
                   $output .= ' checked';
               }
               $output .= '/>
                           <input type="hidden" name="aiomatic_youtube_list[last_run][]" value="' . esc_attr($last_run) . '"/>
                           <input type="hidden" name="aiomatic_youtube_list[rule_unique_id][]" value="' . esc_attr($rule_unique_id) . '"/></td>
               ...
               if ($generated_posts != 0) {
                   $output .= '<a href="' . get_admin_url() . 'edit.php?coderevolution_post_source=Aiomatic_1_' . esc_html($cont) . '&post_type=' . esc_html($def_type) . '" target="_blank">' . esc_html__('View Generated Posts', 'aiomatic-automatic-ai-content-writer') . '</a><br/>';
               }
               ...
               if (!empty($running)) {
                  if (!in_array(array($cont => 1), $running)) {
                        $f = fopen(get_temp_dir() . 'aiomatic_1_' . $cont, 'w');
                        if($f !== false)
                        {
                           flock($f, LOCK_UN);
                           fclose($f);
                           ...
                           $wp_filesystem->delete(get_temp_dir() . 'aiomatic_1_' . $cont);
                        }
                        $output .= ' cr_hidden';
                   }
                   else
               ...
               $output .= '" title="status">
                           ...
                           <select autocomplete="off" class="codemainfzr" id="actions' . esc_html($cont) . '" class="actions" name="actions" onchange="actionsChangedManual(' . esc_html($cont) . ', this.value, 1, \'' . esc_html($rule_unique_id) . '\');" onfocus="this.selectedIndex = 0;">
