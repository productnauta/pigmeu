...
name: Content Idea Generator for Blog Articles
description: Agent prompt to analyze user-provided reference content and propose 5 new article title ideas in pt-BR, grounded in the inputs.
invokable: true
